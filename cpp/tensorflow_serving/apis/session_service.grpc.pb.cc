...
::grpc::Status SessionService::Stub::SessionRun(::grpc::ClientContext* context, const ::tensorflow::serving::SessionRunRequest& request, ::tensorflow::serving::SessionRunResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::tensorflow::serving::SessionRunRequest, ::tensorflow::serving::SessionRunResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SessionRun_, context, request, response);
}
...
void SessionService::Stub::experimental_async::SessionRun(::grpc::ClientContext* context, const ::tensorflow::serving::SessionRunRequest* request, ::tensorflow::serving::SessionRunResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::tensorflow::serving::SessionRunRequest, ::tensorflow::serving::SessionRunResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SessionRun_, context, request, response, std::move(f));
}
...
void SessionService::Stub::experimental_async::SessionRun(::grpc::ClientContext* context, const ::tensorflow::serving::SessionRunRequest* request, ::tensorflow::serving::SessionRunResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SessionRun_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::tensorflow::serving::SessionRunResponse>* SessionService::Stub::PrepareAsyncSessionRunRaw(::grpc::ClientContext* context, const ::tensorflow::serving::SessionRunRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::tensorflow::serving::SessionRunResponse, ::tensorflow::serving::SessionRunRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SessionRun_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::tensorflow::serving::SessionRunResponse>* SessionService::Stub::AsyncSessionRunRaw(::grpc::ClientContext* context, const ::tensorflow::serving::SessionRunRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncSessionRunRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
SessionService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< SessionService::Service, ::tensorflow::serving::SessionRunRequest, ::tensorflow::serving::SessionRunResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](SessionService::Service* service,
