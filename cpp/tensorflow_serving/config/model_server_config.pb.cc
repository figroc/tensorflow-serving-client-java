...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelConfig, alias_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 22, -1, sizeof(::tensorflow::serving::ModelConfigList)},
  { 28, -1, sizeof(::tensorflow::serving::ModelServerConfig)},
};
...
const char descriptor_table_protodef_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "m_storage_path_source.proto\"\272\003\n\013ModelCon"
  "fig\022\014\n\004name\030\001 \001(\t\022\r\n\005alias\030\t \003(\t\022\021\n\tbase"
  "_path\030\002 \001(\t\0225\n\nmodel_type\030\003 \001(\0162\035.tensor"
  "flow.serving.ModelTypeB\002\030\001\022\026\n\016model_plat"
  "form\030\004 \001(\t\022i\n\024model_version_policy\030\007 \001(\013"
  "2K.tensorflow.serving.FileSystemStorageP"
  "athSourceConfig.ServableVersionPolicy\022J\n"
  "\016version_labels\030\010 \003(\01322.tensorflow.servi"
  "ng.ModelConfig.VersionLabelsEntry\0229\n\016log"
  "ging_config\030\006 \001(\0132!.tensorflow.serving.L"
  "oggingConfig\0324\n\022VersionLabelsEntry\022\013\n\003ke"
  "y\030\001 \001(\t\022\r\n\005value\030\002 \001(\003:\0028\001J\004\010\005\020\006\"B\n\017Mode"
  "lConfigList\022/\n\006config\030\001 \003(\0132\037.tensorflow"
  ".serving.ModelConfig\"\224\001\n\021ModelServerConf"
  "ig\022@\n\021model_config_list\030\001 \001(\0132#.tensorfl"
  "ow.serving.ModelConfigListH\000\0223\n\023custom_m"
  "odel_config\030\002 \001(\0132\024.google.protobuf.AnyH"
  "\000B\010\n\006config*N\n\tModelType\022\036\n\026MODEL_TYPE_U"
  "NSPECIFIED\020\000\032\002\010\001\022\022\n\nTENSORFLOW\020\001\032\002\010\001\022\r\n\005"
  "OTHER\020\002\032\002\010\001B\003\370\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto, "tensorflow_serving/config/model_server_config.proto", 984,
...
ModelConfig::ModelConfig(const ModelConfig& from)
  ...
  if (!from._internal_model_platform().empty()) {
    model_platform_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_model_platform(), 
      GetArena());
  }
...
void ModelConfig::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&logging_config_) - reinterpret_cast<char*>(this)),
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 74)) {
          ...
          do {
            ...
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "tensorflow.serving.ModelConfig.alias"));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* ModelConfig::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_alias_size(); i < n; i++) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "tensorflow.serving.ModelConfig.alias");
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.serving.ModelConfig)
  ...
  // repeated string alias = 9;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(alias_.size());
  for (int i = 0, n = alias_.size(); i < n; i++) {
