...
// repeated string alias = 9;
inline int ModelConfig::_internal_alias_size() const {
  return alias_.size();
}
inline int ModelConfig::alias_size() const {
  return _internal_alias_size();
}
inline void ModelConfig::clear_alias() {
  alias_.Clear();
}
inline std::string* ModelConfig::add_alias() {
  // @@protoc_insertion_point(field_add_mutable:tensorflow.serving.ModelConfig.alias)
  return _internal_add_alias();
}
inline const std::string& ModelConfig::_internal_alias(int index) const {
  return alias_.Get(index);
}
inline const std::string& ModelConfig::alias(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.serving.ModelConfig.alias)
  return _internal_alias(index);
}
inline std::string* ModelConfig::mutable_alias(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.serving.ModelConfig.alias)
  return alias_.Mutable(index);
}
inline void ModelConfig::set_alias(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:tensorflow.serving.ModelConfig.alias)
  alias_.Mutable(index)->assign(value);
}
inline void ModelConfig::set_alias(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:tensorflow.serving.ModelConfig.alias)
  alias_.Mutable(index)->assign(std::move(value));
}
inline void ModelConfig::set_alias(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  alias_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:tensorflow.serving.ModelConfig.alias)
}
inline void ModelConfig::set_alias(int index, const char* value, size_t size) {
  alias_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tensorflow.serving.ModelConfig.alias)
}
inline std::string* ModelConfig::_internal_add_alias() {
  return alias_.Add();
}
inline void ModelConfig::add_alias(const std::string& value) {
  alias_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:tensorflow.serving.ModelConfig.alias)
}
inline void ModelConfig::add_alias(std::string&& value) {
  alias_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:tensorflow.serving.ModelConfig.alias)
}
inline void ModelConfig::add_alias(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  alias_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:tensorflow.serving.ModelConfig.alias)
}
inline void ModelConfig::add_alias(const char* value, size_t size) {
  alias_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:tensorflow.serving.ModelConfig.alias)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ModelConfig::alias() const {
  // @@protoc_insertion_point(field_list:tensorflow.serving.ModelConfig.alias)
  return alias_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ModelConfig::mutable_alias() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.serving.ModelConfig.alias)
  return &alias_;
}
...
inline void ModelConfig::_internal_set_model_platform(const std::string& value) {
  ...
  model_platform_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ModelConfig::set_model_platform(const char* value) {
  ...
  model_platform_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:tensorflow.serving.ModelConfig.model_platform)
}
inline void ModelConfig::set_model_platform(const char* value,
    size_t size) {
  
  model_platform_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ModelConfig::_internal_mutable_model_platform() {
  ...
  return model_platform_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
