...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto, "tensorflow/core/protobuf/config.proto", 4871,
...
void RunOptions_Experimental::InternalSwap(RunOptions_Experimental* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(RunOptions_Experimental, collective_graph_key_)>(
          reinterpret_cast<char*>(&collective_graph_key_),
          reinterpret_cast<char*>(&other->collective_graph_key_));
}
