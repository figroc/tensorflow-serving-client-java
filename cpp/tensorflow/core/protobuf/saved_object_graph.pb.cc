...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorflow::FunctionSpec, experimental_compile_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "AZ<github.com/tensorflow/tensorflow/tens"
  "orflow/go/core/protobuf\370\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto, "tensorflow/core/protobuf/saved_object_graph.proto", 2714,
...
constexpr FunctionSpec_ExperimentalCompile FunctionSpec::DEFAULT;
constexpr FunctionSpec_ExperimentalCompile FunctionSpec::ON;
constexpr FunctionSpec_ExperimentalCompile FunctionSpec::OFF;
constexpr FunctionSpec_ExperimentalCompile FunctionSpec::ExperimentalCompile_MIN;
constexpr FunctionSpec_ExperimentalCompile FunctionSpec::ExperimentalCompile_MAX;
constexpr int FunctionSpec::ExperimentalCompile_ARRAYSIZE;
...
FunctionSpec::FunctionSpec(const FunctionSpec& from)
  ...
  ::memcpy(&is_method_, &from.is_method_,
    static_cast<size_t>(reinterpret_cast<char*>(&experimental_compile_) -
    reinterpret_cast<char*>(&is_method_)) + sizeof(experimental_compile_));
...
void FunctionSpec::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      ...
      0, static_cast<size_t>(reinterpret_cast<char*>(&experimental_compile_) -
      reinterpret_cast<char*>(&fullargspec_)) + sizeof(experimental_compile_));
}
...
// @@protoc_insertion_point(message_clear_start:tensorflow.FunctionSpec)
  ...
  ::memset(&is_method_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&experimental_compile_) -
      reinterpret_cast<char*>(&is_method_)) + sizeof(experimental_compile_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_experimental_compile(static_cast<::tensorflow::FunctionSpec_ExperimentalCompile>(val));
        } else goto handle_unusual;
        continue;
      default: {
      handle_unusual:
...
::PROTOBUF_NAMESPACE_ID::uint8* FunctionSpec::_InternalSerialize(
  ...
  // .tensorflow.FunctionSpec.ExperimentalCompile experimental_compile = 6;
  if (this->experimental_compile() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      6, this->_internal_experimental_compile(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.FunctionSpec)
  ...
  if (this->experimental_compile() != 0) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::EnumSize(this->_internal_experimental_compile());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:tensorflow.FunctionSpec)
  ...
  if (from.experimental_compile() != 0) {
    _internal_set_experimental_compile(from._internal_experimental_compile());
  }
}
...
void FunctionSpec::InternalSwap(FunctionSpec* other) {
  ...
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FunctionSpec, experimental_compile_)
      + sizeof(FunctionSpec::experimental_compile_)
