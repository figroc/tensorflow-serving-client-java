...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto, "tensorflow/core/protobuf/saver.proto", 450,
...
SaverDef::SaverDef(const SaverDef& from)
  ...
  if (!from._internal_filename_tensor_name().empty()) {
    filename_tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_filename_tensor_name(), 
      GetArena());
  }
  ...
  if (!from._internal_save_tensor_name().empty()) {
    save_tensor_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_save_tensor_name(), 
      GetArena());
  }
  ...
  if (!from._internal_restore_op_name().empty()) {
    restore_op_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_restore_op_name(), 
      GetArena());
  }
...
void SaverDef::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&max_to_keep_) - reinterpret_cast<char*>(this)),
