...
inline void RewriterConfig::_internal_set_memory_optimizer_target_node_name_scope(const std::string& value) {
  ...
  memory_optimizer_target_node_name_scope_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void RewriterConfig::set_memory_optimizer_target_node_name_scope(const char* value) {
  ...
  memory_optimizer_target_node_name_scope_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:tensorflow.RewriterConfig.memory_optimizer_target_node_name_scope)
}
inline void RewriterConfig::set_memory_optimizer_target_node_name_scope(const char* value,
    size_t size) {
  
  memory_optimizer_target_node_name_scope_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* RewriterConfig::_internal_mutable_memory_optimizer_target_node_name_scope() {
  ...
  return memory_optimizer_target_node_name_scope_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
