...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fverifier_5fconfig_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fverifier_5fconfig_2eproto, "tensorflow/core/protobuf/verifier_config.proto", 343,
...
void VerifierConfig::SharedCtor() {
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&verification_timeout_in_ms_) - reinterpret_cast<char*>(this)),
      0, static_cast<size_t>(reinterpret_cast<char*>(&structure_verifier_) -
      reinterpret_cast<char*>(&verification_timeout_in_ms_)) + sizeof(structure_verifier_));
}
