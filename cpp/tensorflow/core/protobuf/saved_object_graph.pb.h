...
inline bool FunctionSpec_ExperimentalCompile_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, FunctionSpec_ExperimentalCompile* value) {
...
class FunctionSpec PROTOBUF_FINAL :
 ...
 public:
  ...
  static inline bool ExperimentalCompile_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  private:
  ::tensorflow::FunctionSpec_ExperimentalCompile _internal_experimental_compile() const;
  void _internal_set_experimental_compile(::tensorflow::FunctionSpec_ExperimentalCompile value);
  public:
...
inline void SavedBareConcreteFunction::_internal_set_concrete_function_name(const std::string& value) {
  ...
  concrete_function_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void SavedBareConcreteFunction::set_concrete_function_name(const char* value) {
  ...
  concrete_function_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:tensorflow.SavedBareConcreteFunction.concrete_function_name)
}
inline void SavedBareConcreteFunction::set_concrete_function_name(const char* value,
    size_t size) {
  
  concrete_function_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SavedBareConcreteFunction::_internal_mutable_concrete_function_name() {
  ...
  return concrete_function_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline ::tensorflow::SavedVariable* SavedVariable::add_experimental_distributed_variable_components() {
  ...
  return _internal_add_experimental_distributed_variable_components();
}
...
inline ::tensorflow::FunctionSpec_ExperimentalCompile FunctionSpec::_internal_experimental_compile() const {
...
inline ::tensorflow::FunctionSpec_ExperimentalCompile FunctionSpec::experimental_compile() const {
  ...
  return _internal_experimental_compile();
}
inline void FunctionSpec::_internal_set_experimental_compile(::tensorflow::FunctionSpec_ExperimentalCompile value) {
...
inline void FunctionSpec::set_experimental_compile(::tensorflow::FunctionSpec_ExperimentalCompile value) {
  _internal_set_experimental_compile(value);
