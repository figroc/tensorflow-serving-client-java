...
const char descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "(\t\022\035\n\025slot_variable_node_id\030\003 \001(\005BAZ<git"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto, "tensorflow/core/protobuf/trackable_object_graph.proto", 788,
...
TrackableObjectGraph_TrackableObject_SerializedTensor::TrackableObjectGraph_TrackableObject_SerializedTensor(const TrackableObjectGraph_TrackableObject_SerializedTensor& from)
  ...
  if (!from._internal_checkpoint_key().empty()) {
    checkpoint_key_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_checkpoint_key(), 
      GetArena());
  }
...
TrackableObjectGraph_TrackableObject_SlotVariableReference::TrackableObjectGraph_TrackableObject_SlotVariableReference(const TrackableObjectGraph_TrackableObject_SlotVariableReference& from)
  ...
  if (!from._internal_slot_name().empty()) {
    slot_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_slot_name(), 
      GetArena());
  }
...
void TrackableObjectGraph_TrackableObject_SlotVariableReference::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&original_variable_node_id_) - reinterpret_cast<char*>(this)),
      0, static_cast<size_t>(reinterpret_cast<char*>(&slot_variable_node_id_) -
      reinterpret_cast<char*>(&original_variable_node_id_)) + sizeof(slot_variable_node_id_));
}
