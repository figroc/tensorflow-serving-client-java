...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fvariable_2eproto = {
  false, false, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fvariable_2eproto, "tensorflow/core/framework/variable.proto", 939,
...
VariableDef::VariableDef(const VariableDef& from)
  ...
  if (!from._internal_initializer_name().empty()) {
    initializer_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_initializer_name(), 
      GetArena());
  }
  ...
  if (!from._internal_initial_value_name().empty()) {
    initial_value_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_initial_value_name(), 
      GetArena());
  }
...
void VariableDef::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&save_slice_info_def_) - reinterpret_cast<char*>(this)),
