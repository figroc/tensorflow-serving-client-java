...
inline void CostGraphDef_AggregatedCost::_internal_set_dimension(const std::string& value) {
  ...
  dimension_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void CostGraphDef_AggregatedCost::set_dimension(const char* value) {
  ...
  dimension_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:tensorflow.CostGraphDef.AggregatedCost.dimension)
}
inline void CostGraphDef_AggregatedCost::set_dimension(const char* value,
    size_t size) {
  
  dimension_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* CostGraphDef_AggregatedCost::_internal_mutable_dimension() {
  ...
  return dimension_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
