...
inline void AttrValue::set_s(const char* value) {
  ...
  value_.s_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
...
inline void AttrValue::set_placeholder(const char* value) {
  ...
  value_.placeholder_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
      ::std::string(value), GetArena());
