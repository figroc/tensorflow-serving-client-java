...
namespace Tensorflow {
    ...
    static RewriterConfigReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bG9jYXRvck9wdGlvbnMSEQoJZW5hYmxlX29wGAEgAygJIuISCg5SZXdyaXRl",
            ...
            "VG9nZ2xlEh4KFmRpc2FibGVfbWV0YV9vcHRpbWl6ZXIYEyABKAgSTwoZbWV0",
            "YV9vcHRpbWl6ZXJfaXRlcmF0aW9ucxgMIAEoDjIsLnRlbnNvcmZsb3cuUmV3",
            "cml0ZXJDb25maWcuTnVtSXRlcmF0aW9uc1R5cGUSFwoPbWluX2dyYXBoX25v",
            "ZGVzGBEgASgFEjsKM2V4cGVyaW1lbnRhbF9kaXNhYmxlX2NvbXByZXNzZWRf",
            "dGVuc29yX29wdGltaXphdGlvbhgaIAEoCBJCChNtZW1vcnlfb3B0aW1pemF0",
            "aW9uGAQgASgOMiUudGVuc29yZmxvdy5SZXdyaXRlckNvbmZpZy5NZW1PcHRU",
            "eXBlEi8KJ21lbW9yeV9vcHRpbWl6ZXJfdGFyZ2V0X25vZGVfbmFtZV9zY29w",
            "ZRgGIAEoCRIhChltZXRhX29wdGltaXplcl90aW1lb3V0X21zGBQgASgDEjYK",
            "DWF1dG9fcGFyYWxsZWwYBSABKAsyHy50ZW5zb3JmbG93LkF1dG9QYXJhbGxl",
            "bE9wdGlvbnMSIAoYZmFpbF9vbl9vcHRpbWl6ZXJfZXJyb3JzGBUgASgIEkEK",
            "FXNjb3BlZF9hbGxvY2F0b3Jfb3B0cxgQIAEoCzIiLnRlbnNvcmZsb3cuU2Nv",
            "cGVkQWxsb2NhdG9yT3B0aW9ucxISCgpvcHRpbWl6ZXJzGGQgAygJEksKEWN1",
            "c3RvbV9vcHRpbWl6ZXJzGMgBIAMoCzIvLnRlbnNvcmZsb3cuUmV3cml0ZXJD",
            "b25maWcuQ3VzdG9tR3JhcGhPcHRpbWl6ZXISRAofaW50ZXJfb3B0aW1pemVy",
            "X3ZlcmlmaWVyX2NvbmZpZxisAiABKAsyGi50ZW5zb3JmbG93LlZlcmlmaWVy",
            "Q29uZmlnEkYKIXBvc3Rfb3B0aW1pemF0aW9uX3ZlcmlmaWVyX2NvbmZpZxit",
            "AiABKAsyGi50ZW5zb3JmbG93LlZlcmlmaWVyQ29uZmlnGsoBChRDdXN0b21H",
            "cmFwaE9wdGltaXplchIMCgRuYW1lGAEgASgJElgKDXBhcmFtZXRlcl9tYXAY",
            "AiADKAsyQS50ZW5zb3JmbG93LlJld3JpdGVyQ29uZmlnLkN1c3RvbUdyYXBo",
            "T3B0aW1pemVyLlBhcmFtZXRlck1hcEVudHJ5GkoKEVBhcmFtZXRlck1hcEVu",
            "dHJ5EgsKA2tleRgBIAEoCRIkCgV2YWx1ZRgCIAEoCzIVLnRlbnNvcmZsb3cu",
            "QXR0clZhbHVlOgI4ASI2CgZUb2dnbGUSCwoHREVGQVVMVBAAEgYKAk9OEAES",
            "BwoDT0ZGEAISDgoKQUdHUkVTU0lWRRADIkkKCUNwdUxheW91dBIYChROT19D",
            "T05WRVJTSU9OX09OX0NQVRAAEhAKDE5DSFdfVE9fTkhXQxABEhAKDE5IV0Nf",
            "VE9fTkNIVxACIjwKEU51bUl0ZXJhdGlvbnNUeXBlEhUKEURFRkFVTFRfTlVN",
            "X0lURVJTEAASBwoDT05FEAESBwoDVFdPEAIinwEKCk1lbU9wdFR5cGUSEwoP",
            "REVGQVVMVF9NRU1fT1BUEAASDgoKTk9fTUVNX09QVBABEgoKBk1BTlVBTBAC",
            "EhcKE1NXQVBQSU5HX0hFVVJJU1RJQ1MQBBIcChhSRUNPTVBVVEFUSU9OX0hF",
            "VVJJU1RJQ1MQBRIZChVTQ0hFRFVMSU5HX0hFVVJJU1RJQ1MQBhIOCgpIRVVS",
            "SVNUSUNTEANCcwoYb3JnLnRlbnNvcmZsb3cuZnJhbWV3b3JrQhRSZXdyaXRl",
            "ckNvbmZpZ1Byb3Rvc1ABWjxnaXRodWIuY29tL3RlbnNvcmZsb3cvdGVuc29y",
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      optimizers_.WriteTo(ref output, _repeated_optimizers_codec);
      customOptimizers_.WriteTo(ref output, _repeated_customOptimizers_codec);
      if (interOptimizerVerifierConfig_ != null) {
        output.WriteRawTag(226, 18);
        output.WriteMessage(InterOptimizerVerifierConfig);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 802: {
            optimizers_.AddEntriesFrom(ref input, _repeated_optimizers_codec);
            break;
          }
          case 1602: {
            customOptimizers_.AddEntriesFrom(ref input, _repeated_customOptimizers_codec);
            break;
          }
          case 2402: {
            if (interOptimizerVerifierConfig_ == null) {
