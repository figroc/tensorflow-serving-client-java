...
namespace Tensorflow.Serving {
  ...
  /// <summary>Holder for reflection information generated from tensorflow_serving/config/file_system_storage_path_source.proto</summary>
  public static partial class FileSystemStoragePathSourceReflection {

    #region Descriptor
    /// <summary>File descriptor for tensorflow_serving/config/file_system_storage_path_source.proto</summary>
    ...
    static FileSystemStoragePathSourceReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cj90ZW5zb3JmbG93X3NlcnZpbmcvY29uZmlnL2ZpbGVfc3lzdGVtX3N0b3Jh",
            "Z2VfcGF0aF9zb3VyY2UucHJvdG8SEnRlbnNvcmZsb3cuc2VydmluZyKEBwoh",
            "RmlsZVN5c3RlbVN0b3JhZ2VQYXRoU291cmNlQ29uZmlnEloKCXNlcnZhYmxl",
            "cxgFIAMoCzJHLnRlbnNvcmZsb3cuc2VydmluZy5GaWxlU3lzdGVtU3RvcmFn",
            "ZVBhdGhTb3VyY2VDb25maWcuU2VydmFibGVUb01vbml0b3ISGQoNc2VydmFi",
            "bGVfbmFtZRgBIAEoCUICGAESFQoJYmFzZV9wYXRoGAIgASgJQgIYARIlCh1m",
            "aWxlX3N5c3RlbV9wb2xsX3dhaXRfc2Vjb25kcxgDIAEoAxIsCiBmYWlsX2lm",
            "X3plcm9fdmVyc2lvbnNfYXRfc3RhcnR1cBgEIAEoCEICGAESKAogc2VydmFi",
            "bGVfdmVyc2lvbnNfYWx3YXlzX3ByZXNlbnQYBiABKAganQMKFVNlcnZhYmxl",
            "VmVyc2lvblBvbGljeRJkCgZsYXRlc3QYZCABKAsyUi50ZW5zb3JmbG93LnNl",
            "cnZpbmcuRmlsZVN5c3RlbVN0b3JhZ2VQYXRoU291cmNlQ29uZmlnLlNlcnZh",
            "YmxlVmVyc2lvblBvbGljeS5MYXRlc3RIABJeCgNhbGwYZSABKAsyTy50ZW5z",
            "b3JmbG93LnNlcnZpbmcuRmlsZVN5c3RlbVN0b3JhZ2VQYXRoU291cmNlQ29u",
            "ZmlnLlNlcnZhYmxlVmVyc2lvblBvbGljeS5BbGxIABJoCghzcGVjaWZpYxhm",
            "IAEoCzJULnRlbnNvcmZsb3cuc2VydmluZy5GaWxlU3lzdGVtU3RvcmFnZVBh",
            "dGhTb3VyY2VDb25maWcuU2VydmFibGVWZXJzaW9uUG9saWN5LlNwZWNpZmlj",
            "SAAaHgoGTGF0ZXN0EhQKDG51bV92ZXJzaW9ucxgBIAEoDRoFCgNBbGwaHAoI",
            "U3BlY2lmaWMSEAoIdmVyc2lvbnMYASADKANCDwoNcG9saWN5X2Nob2ljZRqx",
            "AQoRU2VydmFibGVUb01vbml0b3ISFQoNc2VydmFibGVfbmFtZRgBIAEoCRIR",
            "CgliYXNlX3BhdGgYAiABKAkSbAoXc2VydmFibGVfdmVyc2lvbl9wb2xpY3kY",
            "BCABKAsySy50ZW5zb3JmbG93LnNlcnZpbmcuRmlsZVN5c3RlbVN0b3JhZ2VQ",
            "YXRoU291cmNlQ29uZmlnLlNlcnZhYmxlVmVyc2lvblBvbGljeUoECAMQBGIG",
            "cHJvdG8z"));
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      servables_.WriteTo(ref output, _repeated_servables_codec);
      if (ServableVersionsAlwaysPresent != false) {
        output.WriteRawTag(48);
        output.WriteBool(ServableVersionsAlwaysPresent);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42: {
            servables_.AddEntriesFrom(ref input, _repeated_servables_codec);
            break;
          }
          case 48: {
            ServableVersionsAlwaysPresent = input.ReadBool();
