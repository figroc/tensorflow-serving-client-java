...
namespace Tensorflow {
    ...
    static ResourceHandleReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "dHlwZXMucHJvdG8iuAIKE1Jlc291cmNlSGFuZGxlUHJvdG8SDgoGZGV2aWNl",
            ...
            "ZGxlUHJvdG8uRHR5cGVBbmRTaGFwZRIXCg9hbGxvd2VkX2RldmljZXMYByAD",
            "KAkaYQoNRHR5cGVBbmRTaGFwZRIjCgVkdHlwZRgBIAEoDjIULnRlbnNvcmZs",
            "b3cuRGF0YVR5cGUSKwoFc2hhcGUYAiABKAsyHC50ZW5zb3JmbG93LlRlbnNv",
            "clNoYXBlUHJvdG9ChwEKGG9yZy50ZW5zb3JmbG93LmZyYW1ld29ya0IOUmVz",
            "b3VyY2VIYW5kbGVQAVpWZ2l0aHViLmNvbS90ZW5zb3JmbG93L3RlbnNvcmZs",
            "b3cvdGVuc29yZmxvdy9nby9jb3JlL2ZyYW1ld29yay9yZXNvdXJjZV9oYW5k",
            "bGVfZ29fcHJvdG/4AQFiBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Tensorflow.ResourceHandleProto), global::Tensorflow.ResourceHandleProto.Parser, new[]{ "Device", "Container", "Name", "HashCode", "MaybeTypeName", "DtypesAndShapes", "AllowedDevices" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { new pbr::GeneratedClrTypeInfo(typeof(global::Tensorflow.ResourceHandleProto.Types.DtypeAndShape), global::Tensorflow.ResourceHandleProto.Types.DtypeAndShape.Parser, new[]{ "Dtype", "Shape" }, null, null, null, null)})
          }));
    }
    #endregion
  ...
  public sealed partial class ResourceHandleProto : pb::IMessage<ResourceHandleProto> {
    ...
    public ResourceHandleProto(ResourceHandleProto other) : this() {
      ...
      allowedDevices_ = other.allowedDevices_.Clone();
    ...
    /// <summary>Field number for the "allowed_devices" field.</summary>
    public const int AllowedDevicesFieldNumber = 7;
    private static readonly pb::FieldCodec<string> _repeated_allowedDevices_codec
        = pb::FieldCodec.ForString(58);
    private readonly pbc::RepeatedField<string> allowedDevices_ = new pbc::RepeatedField<string>();
    /// <summary>
    /// A set of devices containing the resource. If empty, the resource only
    /// exists on `device`.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<string> AllowedDevices {
      get { return allowedDevices_; }
    }
    ...
    public bool Equals(ResourceHandleProto other) {
      ...
      if(!allowedDevices_.Equals(other.allowedDevices_)) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= allowedDevices_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      allowedDevices_.WriteTo(output, _repeated_allowedDevices_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      size += allowedDevices_.CalculateSize(_repeated_allowedDevices_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(ResourceHandleProto other) {
      ...
      allowedDevices_.Add(other.allowedDevices_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 58: {
            allowedDevices_.AddEntriesFrom(input, _repeated_allowedDevices_codec);
            break;
          }
        }
      }
