...
namespace Tensorflow {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      allocationRecords_.WriteTo(ref output, _repeated_allocationRecords_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 50: {
            allocationRecords_.AddEntriesFrom(ref input, _repeated_allocationRecords_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      persistentTensorAllocIds_.WriteTo(ref output, _repeated_persistentTensorAllocIds_codec);
      devicePersistentTensorAllocIds_.WriteTo(ref output, _repeated_devicePersistentTensorAllocIds_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42:
          case 40: {
            persistentTensorAllocIds_.AddEntriesFrom(ref input, _repeated_persistentTensorAllocIds_codec);
            break;
          }
          case 50:
          case 48: {
            devicePersistentTensorAllocIds_.AddEntriesFrom(ref input, _repeated_devicePersistentTensorAllocIds_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      referencedTensor_.WriteTo(ref output, _repeated_referencedTensor_codec);
      if (memoryStats_ != null) {
        output.WriteRawTag(98);
        output.WriteMessage(MemoryStats);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 90: {
            referencedTensor_.AddEntriesFrom(ref input, _repeated_referencedTensor_codec);
            break;
          }
          case 98: {
            if (memoryStats_ == null) {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      nodeStats_.WriteTo(ref output, _repeated_nodeStats_codec);
      threadNames_.WriteTo(ref output, _map_threadNames_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            nodeStats_.AddEntriesFrom(ref input, _repeated_nodeStats_codec);
            break;
          }
          case 26: {
            threadNames_.AddEntriesFrom(ref input, _map_threadNames_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      devStats_.WriteTo(ref output, _repeated_devStats_codec);
      if (_unknownFields != null) {
        _unknownFields.WriteTo(ref output);
      }
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            devStats_.AddEntriesFrom(ref input, _repeated_devStats_codec);
            break;
          }
        }
      }
