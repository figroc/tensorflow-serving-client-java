...
namespace Tensorflow {
    ...
    static ConfigReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cnNpb24YAiABKAMimgwKC0NvbmZpZ1Byb3RvEj4KDGRldmljZV9jb3VudBgB",
            ...
            "CRINCgV2YWx1ZRgCIAEoBToCOAEalAYKDEV4cGVyaW1lbnRhbBIfChdjb2xs",
            ...
            "DyABKAMiewoRTWxpckJyaWRnZVJvbGxvdXQSIwofTUxJUl9CUklER0VfUk9M",
            "TE9VVF9VTlNQRUNJRklFRBAAEh8KG01MSVJfQlJJREdFX1JPTExPVVRfRU5B",
            "QkxFRBABEiAKHE1MSVJfQlJJREdFX1JPTExPVVRfRElTQUJMRUQQAkoECAIQ",
            "AyLhBAoKUnVuT3B0aW9ucxI2Cgt0cmFjZV9sZXZlbBgBIAEoDjIhLnRlbnNv",
            "cmZsb3cuUnVuT3B0aW9ucy5UcmFjZUxldmVsEhUKDXRpbWVvdXRfaW5fbXMY",
            "AiABKAMSHAoUaW50ZXJfb3BfdGhyZWFkX3Bvb2wYAyABKAUSHwoXb3V0cHV0",
            "X3BhcnRpdGlvbl9ncmFwaHMYBSABKAgSLwoNZGVidWdfb3B0aW9ucxgGIAEo",
            "CzIYLnRlbnNvcmZsb3cuRGVidWdPcHRpb25zEioKInJlcG9ydF90ZW5zb3Jf",
            "YWxsb2NhdGlvbnNfdXBvbl9vb20YByABKAgSOQoMZXhwZXJpbWVudGFsGAgg",
            "ASgLMiMudGVuc29yZmxvdy5SdW5PcHRpb25zLkV4cGVyaW1lbnRhbBrSAQoM",
            "RXhwZXJpbWVudGFsEhwKFGNvbGxlY3RpdmVfZ3JhcGhfa2V5GAEgASgDEhwK",
            "FHVzZV9ydW5faGFuZGxlcl9wb29sGAIgASgIElsKGHJ1bl9oYW5kbGVyX3Bv",
            "b2xfb3B0aW9ucxgDIAEoCzI5LnRlbnNvcmZsb3cuUnVuT3B0aW9ucy5FeHBl",
            "cmltZW50YWwuUnVuSGFuZGxlclBvb2xPcHRpb25zGikKFVJ1bkhhbmRsZXJQ",
            "b29sT3B0aW9ucxIQCghwcmlvcml0eRgBIAEoAyJSCgpUcmFjZUxldmVsEgwK",
            "CE5PX1RSQUNFEAASEgoOU09GVFdBUkVfVFJBQ0UQARISCg5IQVJEV0FSRV9U",
            "UkFDRRACEg4KCkZVTExfVFJBQ0UQA0oECAQQBSKHAwoLUnVuTWV0YWRhdGES",
            "KQoKc3RlcF9zdGF0cxgBIAEoCzIVLnRlbnNvcmZsb3cuU3RlcFN0YXRzEiwK",
            "CmNvc3RfZ3JhcGgYAiABKAsyGC50ZW5zb3JmbG93LkNvc3RHcmFwaERlZhIu",
            "ChBwYXJ0aXRpb25fZ3JhcGhzGAMgAygLMhQudGVuc29yZmxvdy5HcmFwaERl",
            "ZhI/Cg9mdW5jdGlvbl9ncmFwaHMYBCADKAsyJi50ZW5zb3JmbG93LlJ1bk1l",
            "dGFkYXRhLkZ1bmN0aW9uR3JhcGhzGq0BCg5GdW5jdGlvbkdyYXBocxIuChBw",
            "YXJ0aXRpb25fZ3JhcGhzGAEgAygLMhQudGVuc29yZmxvdy5HcmFwaERlZhI0",
            "ChZwcmVfb3B0aW1pemF0aW9uX2dyYXBoGAIgASgLMhQudGVuc29yZmxvdy5H",
            "cmFwaERlZhI1Chdwb3N0X29wdGltaXphdGlvbl9ncmFwaBgDIAEoCzIULnRl",
            "bnNvcmZsb3cuR3JhcGhEZWYiOgoQVGVuc29yQ29ubmVjdGlvbhITCgtmcm9t",
            "X3RlbnNvchgBIAEoCRIRCgl0b190ZW5zb3IYAiABKAkisAMKD0NhbGxhYmxl",
            "T3B0aW9ucxIMCgRmZWVkGAEgAygJEg0KBWZldGNoGAIgAygJEg4KBnRhcmdl",
            "dBgDIAMoCRIrCgtydW5fb3B0aW9ucxgEIAEoCzIWLnRlbnNvcmZsb3cuUnVu",
            "T3B0aW9ucxI3ChF0ZW5zb3JfY29ubmVjdGlvbhgFIAMoCzIcLnRlbnNvcmZs",
            "b3cuVGVuc29yQ29ubmVjdGlvbhJCCgxmZWVkX2RldmljZXMYBiADKAsyLC50",
            "ZW5zb3JmbG93LkNhbGxhYmxlT3B0aW9ucy5GZWVkRGV2aWNlc0VudHJ5EkQK",
            "DWZldGNoX2RldmljZXMYByADKAsyLS50ZW5zb3JmbG93LkNhbGxhYmxlT3B0",
            "aW9ucy5GZXRjaERldmljZXNFbnRyeRIXCg9mZXRjaF9za2lwX3N5bmMYCCAB",
            "KAgaMgoQRmVlZERldmljZXNFbnRyeRILCgNrZXkYASABKAkSDQoFdmFsdWUY",
            "AiABKAk6AjgBGjMKEUZldGNoRGV2aWNlc0VudHJ5EgsKA2tleRgBIAEoCRIN",
            "CgV2YWx1ZRgCIAEoCToCOAFCawoYb3JnLnRlbnNvcmZsb3cuZnJhbWV3b3Jr",
            "QgxDb25maWdQcm90b3NQAVo8Z2l0aHViLmNvbS90ZW5zb3JmbG93L3RlbnNv",
            "cmZsb3cvdGVuc29yZmxvdy9nby9jb3JlL3Byb3RvYnVm+AEBYgZwcm90bzM="));
  ...
  #endif
  {
    ...
    public static partial class Types {
      ...
      #endif
      {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
          virtualDevices_.WriteTo(ref output, _repeated_virtualDevices_codec);
          if (UseUnifiedMemory != false) {
            output.WriteRawTag(16);
            output.WriteBool(UseUnifiedMemory);
          }
          ...
          while ((tag = input.ReadTag()) != 0) {
            switch(tag) {
              default:
                ...
                break;
              case 10: {
                virtualDevices_.AddEntriesFrom(ref input, _repeated_virtualDevices_codec);
                break;
              }
              case 16: {
                UseUnifiedMemory = input.ReadBool();
        ...
        public static partial class Types {
          ...
          #endif
          {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
            void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
              memoryLimitMb_.WriteTo(ref output, _repeated_memoryLimitMb_codec);
              priority_.WriteTo(ref output, _repeated_priority_codec);
              if (_unknownFields != null) {
                _unknownFields.WriteTo(ref output);
              }
            }
            ...
            void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
              ...
              while ((tag = input.ReadTag()) != 0) {
                switch(tag) {
                  ...
                  case 10:
                  case 13: {
                    memoryLimitMb_.AddEntriesFrom(ref input, _repeated_memoryLimitMb_codec);
                    break;
                  }
                  case 18:
                  case 16: {
                    priority_.AddEntriesFrom(ref input, _repeated_priority_codec);
                    break;
                  }
                }
              }
  ...
  #endif
  {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      deviceCount_.WriteTo(ref output, _map_deviceCount_codec);
      if (IntraOpParallelismThreads != 0) {
        output.WriteRawTag(16);
        output.WriteInt32(IntraOpParallelismThreads);
      }
      ...
      deviceFilters_.WriteTo(ref output, _repeated_deviceFilters_codec);
      if (InterOpParallelismThreads != 0) {
        output.WriteRawTag(40);
        output.WriteInt32(InterOpParallelismThreads);
      }
      ...
      sessionInterOpThreadPool_.WriteTo(ref output, _repeated_sessionInterOpThreadPool_codec);
      if (rpcOptions_ != null) {
        output.WriteRawTag(106);
        output.WriteMessage(RpcOptions);
      }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            deviceCount_.AddEntriesFrom(ref input, _map_deviceCount_codec);
            break;
          }
          case 16: {
            IntraOpParallelismThreads = input.ReadInt32();
          ...
          case 34: {
            deviceFilters_.AddEntriesFrom(ref input, _repeated_deviceFilters_codec);
            break;
          }
          case 40: {
            InterOpParallelismThreads = input.ReadInt32();
          ...
          case 98: {
            sessionInterOpThreadPool_.AddEntriesFrom(ref input, _repeated_sessionInterOpThreadPool_codec);
            break;
          }
          case 106: {
            if (rpcOptions_ == null) {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      partitionGraphs_.WriteTo(ref output, _repeated_partitionGraphs_codec);
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26: {
            partitionGraphs_.AddEntriesFrom(ref input, _repeated_partitionGraphs_codec);
            break;
          }
          case 34: {
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      fetch_.WriteTo(ref output, _repeated_fetch_codec);
      target_.WriteTo(ref output, _repeated_target_codec);
      if (runOptions_ != null) {
        output.WriteRawTag(34);
        output.WriteMessage(RunOptions);
      }
      tensorConnection_.WriteTo(ref output, _repeated_tensorConnection_codec);
      feedDevices_.WriteTo(ref output, _map_feedDevices_codec);
      fetchDevices_.WriteTo(ref output, _map_fetchDevices_codec);
      if (FetchSkipSync != false) {
        output.WriteRawTag(64);
        output.WriteBool(FetchSkipSync);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            fetch_.AddEntriesFrom(ref input, _repeated_fetch_codec);
            break;
          }
          case 26: {
          ...
          case 42: {
            tensorConnection_.AddEntriesFrom(ref input, _repeated_tensorConnection_codec);
            break;
          }
          case 50: {
            feedDevices_.AddEntriesFrom(ref input, _map_feedDevices_codec);
            break;
          }
          case 58: {
            fetchDevices_.AddEntriesFrom(ref input, _map_fetchDevices_codec);
            break;
          }
          case 64: {
            FetchSkipSync = input.ReadBool();
