...
namespace Tensorflow {
    ...
    static MetaGraphReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ckluZm8SEAoIZmlsZW5hbWUYAiABKAlCbgoYb3JnLnRlbnNvcmZsb3cuZnJh",
            "bWV3b3JrQg9NZXRhR3JhcGhQcm90b3NQAVo8Z2l0aHViLmNvbS90ZW5zb3Jm",
            "bG93L3RlbnNvcmZsb3cvdGVuc29yZmxvdy9nby9jb3JlL3Byb3RvYnVm+AEB",
            "YgZwcm90bzM="));
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      collectionDef_.WriteTo(ref output, _map_collectionDef_codec);
      signatureDef_.WriteTo(ref output, _map_signatureDef_codec);
      assetFileDef_.WriteTo(ref output, _repeated_assetFileDef_codec);
      if (objectGraphDef_ != null) {
        output.WriteRawTag(58);
        output.WriteMessage(ObjectGraphDef);
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 34: {
            collectionDef_.AddEntriesFrom(ref input, _map_collectionDef_codec);
            break;
          }
          case 42: {
          ...
          case 50: {
            assetFileDef_.AddEntriesFrom(ref input, _repeated_assetFileDef_codec);
            break;
          }
          case 58: {
            if (objectGraphDef_ == null) {
    ...
    public static partial class Types {
      ...
      #endif
      {
        ...
        void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
          ...
          functionAliases_.WriteTo(ref output, _map_functionAliases_codec);
          if (_unknownFields != null) {
            _unknownFields.WriteTo(ref output);
          }
        }
        ...
        void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
          ...
          while ((tag = input.ReadTag()) != 0) {
            switch(tag) {
              ...
              case 66: {
                functionAliases_.AddEntriesFrom(ref input, _map_functionAliases_codec);
                break;
              }
            }
          }
