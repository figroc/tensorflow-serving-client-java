...
pub struct FunctionSpec {
    ...
    pub experimental_compile: FunctionSpec_ExperimentalCompile,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl FunctionSpec {
    ...
    pub fn get_experimental_compile(&self) -> FunctionSpec_ExperimentalCompile {
        self.experimental_compile
    }
    pub fn clear_experimental_compile(&mut self) {
        self.experimental_compile = FunctionSpec_ExperimentalCompile::DEFAULT;
    }

    // Param is passed by value, moved
    pub fn set_experimental_compile(&mut self, v: FunctionSpec_ExperimentalCompile) {
        self.experimental_compile = v;
    }
}
...
impl ::protobuf::Message for FunctionSpec {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                6 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.experimental_compile, 6, &mut self.unknown_fields)?
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.experimental_compile != FunctionSpec_ExperimentalCompile::DEFAULT {
            my_size += ::protobuf::rt::enum_size(6, self.experimental_compile);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.experimental_compile != FunctionSpec_ExperimentalCompile::DEFAULT {
            os.write_enum(6, ::protobuf::ProtobufEnum::value(&self.experimental_compile))?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<FunctionSpec_ExperimentalCompile>>(
                "experimental_compile",
                |m: &FunctionSpec| { &m.experimental_compile },
                |m: &mut FunctionSpec| { &mut m.experimental_compile },
            ));
...
pub enum FunctionSpec_ExperimentalCompile {
    DEFAULT = 0,
    ON = 1,
    OFF = 2,
}

impl ::protobuf::ProtobufEnum for FunctionSpec_ExperimentalCompile {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<FunctionSpec_ExperimentalCompile> {
        match value {
            0 => ::std::option::Option::Some(FunctionSpec_ExperimentalCompile::DEFAULT),
            1 => ::std::option::Option::Some(FunctionSpec_ExperimentalCompile::ON),
            2 => ::std::option::Option::Some(FunctionSpec_ExperimentalCompile::OFF),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [FunctionSpec_ExperimentalCompile] = &[
            FunctionSpec_ExperimentalCompile::DEFAULT,
            FunctionSpec_ExperimentalCompile::ON,
            FunctionSpec_ExperimentalCompile::OFF,
        ];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<FunctionSpec_ExperimentalCompile>("FunctionSpec.ExperimentalCompile", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for FunctionSpec_ExperimentalCompile {
}

impl ::std::default::Default for FunctionSpec_ExperimentalCompile {
    fn default() -> Self {
        FunctionSpec_ExperimentalCompile::DEFAULT
    }
}

impl ::protobuf::reflect::ProtobufValue for FunctionSpec_ExperimentalCompile {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    entalDistributedVariableComponents\"\xd2\x02\n\x0cFunctionSpec\x12=\n\
    ...
    edValueR\x0einputSignature\x12_\n\x14experimental_compile\x18\x06\x20\
    \x01(\x0e2,.tensorflow.FunctionSpec.ExperimentalCompileR\x13experimental\
    Compile\"3\n\x13ExperimentalCompile\x12\x0b\n\x07DEFAULT\x10\0\x12\x06\n\
    \x02ON\x10\x01\x12\x07\n\x03OFF\x10\x02J\x04\x08\x03\x10\x04J\x04\x08\
    \x04\x10\x05\"'\n\rSavedResource\x12\x16\n\x06device\x18\x01\x20\x01(\tR\
    \x06device\"`\n\x0eSaveableObject\x12#\n\rsave_function\x18\x02\x20\x01(\
    \x05R\x0csaveFunction\x12)\n\x10restore_function\x18\x03\x20\x01(\x05R\
    \x0frestoreFunctionBAZ<github.com/tensorflow/tensorflow/tensorflow/go/co\
    re/protobuf\xf8\x01\x01J\xc2?\n\x07\x12\x05\0\0\xca\x01\x01\n\x08\n\x01\
    ...
    \x0c\n\x05\x04\x05\x02\x02\x03\x12\x03s%&\n\x0b\n\x02\x04\x06\x12\x05v\0\
    \x85\x01\x01\n\n\n\x03\x04\x06\x01\x12\x03v\x08!\n2\n\x04\x04\x06\x02\0\
    \x12\x03x\x02$\x1a%\x20Identifies\x20a\x20SavedConcreteFunction.\n\n\x0c\
    ...
    \x03\x12\x03{&'\nU\n\x04\x04\x06\x02\x02\x12\x03}\x02)\x1aH\x20The\x20pr\
    efix\x20of\x20`argument_keywords`\x20which\x20may\x20be\x20identified\
    \x20by\x20position.\n\n\x0c\n\x05\x04\x06\x02\x02\x05\x12\x03}\x02\x07\n\
    \x0c\n\x05\x04\x06\x02\x02\x01\x12\x03}\x08$\n\x0c\n\x05\x04\x06\x02\x02\
    \x03\x12\x03}'(\n\x80\x03\n\x04\x04\x06\x02\x03\x12\x04\x84\x01\x02!\x1a\
    \xf1\x02\x20The\x20spec\x20of\x20the\x20function\x20that\x20this\x20Conc\
    reteFunction\x20is\x20traced\x20from.\x20This\n\x20allows\x20the\x20Conc\
    reteFunction\x20to\x20be\x20called\x20with\x20nest\x20structure\x20input\
    s.\x20This\n\x20field\x20may\x20not\x20be\x20populated.\x20If\x20this\
    \x20field\x20is\x20absent,\x20the\x20concrete\x20function\n\x20can\x20on\
    ly\x20be\x20called\x20with\x20flat\x20inputs.\n\x20TODO(b/169361281):\
    \x20support\x20calling\x20saved\x20ConcreteFunction\x20with\x20structure\
    d\n\x20inputs\x20in\x20C++\x20SavedModel\x20API.\n\n\r\n\x05\x04\x06\x02\
    \x03\x06\x12\x04\x84\x01\x02\x0e\n\r\n\x05\x04\x06\x02\x03\x01\x12\x04\
    \x84\x01\x0f\x1c\n\r\n\x05\x04\x06\x02\x03\x03\x12\x04\x84\x01\x1f\x20\n\
    \x0c\n\x02\x04\x07\x12\x06\x87\x01\0\x8a\x01\x01\n\x0b\n\x03\x04\x07\x01\
    \x12\x04\x87\x01\x08\x15\nX\n\x04\x04\x07\x02\0\x12\x04\x89\x01\x02\x17\
    \x1aJ\x20An\x20Operation\x20name\x20for\x20a\x20ConstantOp\x20in\x20this\
    \x20SavedObjectGraph's\x20MetaGraph.\n\n\r\n\x05\x04\x07\x02\0\x05\x12\
    \x04\x89\x01\x02\x08\n\r\n\x05\x04\x07\x02\0\x01\x12\x04\x89\x01\t\x12\n\
    \r\n\x05\x04\x07\x02\0\x03\x12\x04\x89\x01\x15\x16\ng\n\x02\x04\x08\x12\
    \x06\x8e\x01\0\x9d\x01\x01\x1aY\x20Represents\x20a\x20Variable\x20that\
    \x20is\x20initialized\x20by\x20loading\x20the\x20contents\x20from\x20the\
    \n\x20checkpoint.\n\n\x0b\n\x03\x04\x08\x01\x12\x04\x8e\x01\x08\x15\n\
    \x0c\n\x04\x04\x08\x02\0\x12\x04\x8f\x01\x02\x15\n\r\n\x05\x04\x08\x02\0\
    \x12\x04\x9c\x01\x0b\x18\n\r\n\x05\x04\x08\x02\x07\x01\x12\x04\x9c\x01\
    \x19E\n\r\n\x05\x04\x08\x02\x07\x03\x12\x04\x9c\x01HI\n\x8b\x01\n\x02\
    \x04\t\x12\x06\xa2\x01\0\xba\x01\x01\x1a}\x20Represents\x20`FunctionSpec\
    `\x20used\x20in\x20`Function`.\x20This\x20represents\x20a\n\x20function\
    \x20that\x20has\x20been\x20wrapped\x20as\x20a\x20TensorFlow\x20`Function\
    `.\n\n\x0b\n\x03\x04\t\x01\x12\x04\xa2\x01\x08\x14\n<\n\x04\x04\t\x02\0\
    \x12\x04\xa4\x01\x02\"\x1a.\x20Full\x20arg\x20spec\x20from\x20inspect.ge\
    tfullargspec().\n\n\r\n\x05\x04\t\x02\0\x06\x12\x04\xa4\x01\x02\x11\n\r\
    \n\x05\x04\t\x02\0\x01\x12\x04\xa4\x01\x12\x1d\n\r\n\x05\x04\t\x02\0\x03\
    \x12\x04\xa4\x01\x20!\n7\n\x04\x04\t\x02\x01\x12\x04\xa6\x01\x02\x15\x1a\
    )\x20Whether\x20this\x20represents\x20a\x20class\x20method.\n\n\r\n\x05\
    \x04\t\x02\x01\x05\x12\x04\xa6\x01\x02\x06\n\r\n\x05\x04\t\x02\x01\x01\
    \x12\x04\xa6\x01\x07\x10\n\r\n\x05\x04\t\x02\x01\x03\x12\x04\xa6\x01\x13\
    \x14\n2\n\x04\x04\t\x02\x02\x12\x04\xa8\x01\x02&\x1a$\x20The\x20input\
    \x20signature,\x20if\x20specified.\n\n\r\n\x05\x04\t\x02\x02\x06\x12\x04\
    \xa8\x01\x02\x11\n\r\n\x05\x04\t\x02\x02\x01\x12\x04\xa8\x01\x12!\n\r\n\
    \x05\x04\t\x02\x02\x03\x12\x04\xa8\x01$%\n\xdf\x02\n\x04\x04\t\x04\0\x12\
    \x06\xb2\x01\x02\xb6\x01\x03\x1a\xce\x02\x20Whether\x20the\x20function\
    \x20should\x20be\x20compiled\x20by\x20XLA.\n\n\x20The\x20public\x20inter\
    face\x20to\x20`tf.function`\x20uses\x20an\x20optional\x20boolean\x20to\n\
    \x20represent\x20three\x20distinct\x20states\x20for\x20this\x20field.\
    \x20\x20Unfortunately,\x20proto3\n\x20removes\x20the\x20ability\x20to\
    \x20explicitly\x20check\x20for\x20the\x20presence\x20or\x20absence\x20of\
    \x20a\n\x20field,\x20so\x20we\x20instead\x20map\x20to\x20an\x20enum.\n\n\
    \x20See\x20`tf.function`\x20for\x20details.\n\n\r\n\x05\x04\t\x04\0\x01\
    \x12\x04\xb2\x01\x07\x1a\n\x0e\n\x06\x04\t\x04\0\x02\0\x12\x04\xb3\x01\
    \x04\x10\n\x0f\n\x07\x04\t\x04\0\x02\0\x01\x12\x04\xb3\x01\x04\x0b\n\x0f\
    \n\x07\x04\t\x04\0\x02\0\x02\x12\x04\xb3\x01\x0e\x0f\n\x0e\n\x06\x04\t\
