...
impl ::protobuf::Message for ExampleList {
    ...
    fn default_instance() -> &'static ExampleList {
        static instance: ::protobuf::rt::LazyV2<ExampleList> = ::protobuf::rt::LazyV2::INIT;
...
impl ExampleListWithContext {
    ...
    pub fn get_context(&self) -> &super::example::Example {
        self.context.as_ref().unwrap_or_else(|| <super::example::Example as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for ExampleListWithContext {
    ...
    fn default_instance() -> &'static ExampleListWithContext {
        static instance: ::protobuf::rt::LazyV2<ExampleListWithContext> = ::protobuf::rt::LazyV2::INIT;
...
impl Input {
    ...
    pub fn get_example_list(&self) -> &ExampleList {
        match self.kind {
            ...
            _ => <ExampleList as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn get_example_list_with_context(&self) -> &ExampleListWithContext {
        match self.kind {
            ...
            _ => <ExampleListWithContext as ::protobuf::Message>::default_instance(),
        }
    }
