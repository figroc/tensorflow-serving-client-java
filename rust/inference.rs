...
impl ::protobuf::Message for InferenceTask {
    ...
    fn default_instance() -> &'static InferenceTask {
        static instance: ::protobuf::rt::LazyV2<InferenceTask> = ::protobuf::rt::LazyV2::INIT;
...
impl InferenceResult {
    ...
    pub fn get_classification_result(&self) -> &super::classification::ClassificationResult {
        match self.result {
            ...
            _ => <super::classification::ClassificationResult as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn get_regression_result(&self) -> &super::regression::RegressionResult {
        match self.result {
            ...
            _ => <super::regression::RegressionResult as ::protobuf::Message>::default_instance(),
        }
    }
...
impl ::protobuf::Message for MultiInferenceRequest {
    ...
    fn default_instance() -> &'static MultiInferenceRequest {
        static instance: ::protobuf::rt::LazyV2<MultiInferenceRequest> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for MultiInferenceResponse {
    ...
    fn default_instance() -> &'static MultiInferenceResponse {
        static instance: ::protobuf::rt::LazyV2<MultiInferenceResponse> = ::protobuf::rt::LazyV2::INIT;
