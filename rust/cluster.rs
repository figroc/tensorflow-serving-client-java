...
impl ::protobuf::Message for JobDef {
    ...
    fn default_instance() -> &'static JobDef {
        static mut instance: ::protobuf::lazy::Lazy<JobDef> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for ClusterDef {
    ...
    fn default_instance() -> &'static ClusterDef {
        static mut instance: ::protobuf::lazy::Lazy<ClusterDef> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    job\x18\x01\x20\x03(\x0b2\x12.tensorflow.JobDefR\x03jobBz\n\x1aorg.tenso\
    rflow.distruntimeB\rClusterProtosP\x01ZHgithub.com/tensorflow/tensorflow\
    /tensorflow/go/core/core_protos_go_proto\xf8\x01\x01J\x9e\x16\n\x06\x12\
    ...
    \x12\x04C\0M\x01\x1a/\x20Defines\x20a\x20single\x20job\x20in\x20a\x20Ten\
    sorFlow\x20cluster.\n2\xfe\n\x20This\x20file\x20contains\x20protos\x20to\
    \x20be\x20used\x20when\x20defining\x20a\x20TensorFlow\n\x20cluster.\n\n\
    \x20EXAMPLES\n\x20--------\n\n\x201.\x20A\x20single-process\x20cluster,\
    \x20containing\x20\"/job:local/task:0\".\n\n\x20\x20\x20\x20Cluster:\n\
    \x20\x20\x20\x20\x20\x20job\x20{\x20name:\x20'local'\x20tasks\x20{\x20ke\
    y:\x200\x20value:\x20'localhost:2222'\x20}\x20}\n\n\x20\x20\x20\x20Serve\
    ...
    ,\x20containing\x20\"/job:local/task:{0,1}\".\n\n\x20\x20\x20\x20Cluster\
    :\n\x20\x20\x20\x20\x20\x20job\x20{\x20name:\x20'local'\x20tasks\x20{\
    \x20key:\x200\x20value:\x20'localhost:2222'\x20}\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20tasks\x20{\x20key:\x201\x20value:\x20'localhost:2223'\x20}\
    \x20}\n\n\x20\x20\x20\x20Servers:\n\x20\x20\x20\x20\x20\x20cluster\x20{\
    \x20$CLUSTER\x20}\x20job_name:\x20'local'\x20task_index:\x200\n\x20\x20\
    \x20\x20\x20\x20cluster\x20{\x20$CLUSTER\x20}\x20job_name:\x20'local'\
    \x20task_index:\x201\n\n\x203.\x20A\x20two-job\x20cluster,\x20containing\
    \x20\"/job:worker/task:{0,1,2}\"\x20and\n\x20\x20\x20\x20\"/job:ps/task:\
    {0,1}\".\n\n\x20\x20\x20\x20Cluster:\n\x20\x20\x20\x20\x20\x20job\x20{\
    \x20name:\x20'worker'\x20tasks\x20{\x20key:\x200\x20value:\x20'worker1:2\
    222'\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20tasks\x20{\x20key:\x201\
    \x20value:\x20'worker2:2222'\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    tasks\x20{\x20key:\x202\x20value:\x20'worker3:2222'\x20}\x20}\n\x20\x20\
    \x20\x20\x20\x20job\x20{\x20name:\x20'ps'\x20\x20\x20\x20\x20tasks\x20{\
    \x20key:\x200\x20value:\x20'ps0:2222'\x20}\n\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20tasks\x20{\x20key:\x201\x20value:\x20'ps1:2222'\x20}\x20}\n\n\
    \x20\x20\x20\x20Servers:\n\x20\x20\x20\x20\x20\x20cluster\x20{\x20$CLUST\
    ER\x20}\x20job_name:\x20'worker'\x20task_index:\x200\n\x20\x20\x20\x20\
    ...
    _name:\x20'worker'\x20task_index:\x202\n\x20\x20\x20\x20\x20\x20cluster\
    \x20{\x20$CLUSTER\x20}\x20job_name:\x20'ps'\x20\x20\x20\x20\x20task_inde\
    x:\x200\n\x20\x20\x20\x20\x20\x20cluster\x20{\x20$CLUSTER\x20}\x20job_na\
    me:\x20'ps'\x20\x20\x20\x20\x20task_index:\x201\n\n\n\n\x03\x04\0\x01\
    \x12\x03C\x08\x0e\n$\n\x04\x04\0\x02\0\x12\x03E\x02\x12\x1a\x17\x20The\
    \x20name\x20of\x20this\x20job.\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03E\
    ...
    \x05\x04\0\x02\x01\x01\x12\x03L\x15\x1a\n\x0c\n\x05\x04\0\x02\x01\x03\
    \x12\x03L\x1d\x1e\n<\n\x02\x04\x01\x12\x04P\0S\x01\x1a0\x20Defines\x20a\
    \x20TensorFlow\x20cluster\x20as\x20a\x20set\x20of\x20jobs.\n\n\n\n\x03\
    \x04\x01\x01\x12\x03P\x08\x12\n2\n\x04\x04\x01\x02\0\x12\x03R\x02\x1a\
    \x1a%\x20The\x20jobs\x20that\x20comprise\x20the\x20cluster.\n\n\x0c\n\
    \x05\x04\x01\x02\0\x04\x12\x03R\x02\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\
    \x03R\x0b\x11\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03R\x12\x15\n\x0c\n\x05\
    \x04\x01\x02\0\x03\x12\x03R\x18\x19b\x06proto3\
";
