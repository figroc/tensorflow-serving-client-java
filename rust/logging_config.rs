...
impl ::protobuf::Message for SamplingConfig {
    ...
    fn default_instance() -> &'static SamplingConfig {
        static instance: ::protobuf::rt::LazyV2<SamplingConfig> = ::protobuf::rt::LazyV2::INIT;
...
impl LoggingConfig {
    ...
    pub fn get_log_collector_config(&self) -> &super::log_collector_config::LogCollectorConfig {
        self.log_collector_config.as_ref().unwrap_or_else(|| <super::log_collector_config::LogCollectorConfig as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get_sampling_config(&self) -> &SamplingConfig {
        self.sampling_config.as_ref().unwrap_or_else(|| <SamplingConfig as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for LoggingConfig {
    ...
    fn default_instance() -> &'static LoggingConfig {
        static instance: ::protobuf::rt::LazyV2<LoggingConfig> = ::protobuf::rt::LazyV2::INIT;
