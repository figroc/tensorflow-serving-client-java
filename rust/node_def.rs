...
impl ::protobuf::Message for NodeDef_ExperimentalDebugInfo {
    ...
    fn default_instance() -> &'static NodeDef_ExperimentalDebugInfo {
        static mut instance: ::protobuf::lazy::Lazy<NodeDef_ExperimentalDebugInfo> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    go/core/framework/node_def_go_proto\xf8\x01\x01J\xe7\x1c\n\x06\x12\x04\0\
    ...
    \x20name\x20given\x20to\x20this\x20operator.\x20Used\x20for\x20naming\
    ...
    \0\x02\0\x03\x12\x03\x10\x10\x11\n\x92\x01\n\x04\x04\0\x02\x01\x12\x03\
    \x14\x02\x10\x1a\x84\x01\x20The\x20operation\x20name.\x20\x20There\x20ma\
    y\x20be\x20custom\x20parameters\x20in\x20attrs.\n\x20Op\x20names\x20star\
    ting\x20with\x20an\x20underscore\x20are\x20reserved\x20for\x20internal\
    \x20use.\n\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x14\x02\x08\n\x0c\n\x05\
    \x04\0\x02\x01\x01\x12\x03\x14\t\x0b\n\x0c\n\x05\x04\0\x02\x01\x03\x12\
    \x03\x14\x0e\x0f\n\xa7\x02\n\x04\x04\0\x02\x02\x12\x03\x1b\x02\x1c\x1a\
    \x99\x02\x20Each\x20input\x20is\x20\"node:src_output\"\x20with\x20\"node\
    \"\x20being\x20a\x20string\x20name\x20and\n\x20\"src_output\"\x20indicat\
    ing\x20which\x20output\x20tensor\x20to\x20use\x20from\x20\"node\".\x20If\
    \n\x20\"src_output\"\x20is\x200\x20the\x20\":0\"\x20suffix\x20can\x20be\
    \x20omitted.\x20\x20Regular\x20inputs\n\x20may\x20optionally\x20be\x20fo\
    llowed\x20by\x20control\x20inputs\x20that\x20have\x20the\x20format\n\x20\
    \"^node\".\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03\x1b\x02\n\n\x0c\n\x05\
    \x04\0\x02\x02\x05\x12\x03\x1b\x0b\x11\n\x0c\n\x05\x04\0\x02\x02\x01\x12\
    \x03\x1b\x12\x17\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03\x1b\x1a\x1b\n\xa1\
    \x06\n\x04\x04\0\x02\x03\x12\x031\x02\x14\x1a\x93\x06\x20A\x20(possibly\
    \x20partial)\x20specification\x20for\x20the\x20device\x20on\x20which\x20\
    this\n\x20node\x20should\x20be\x20placed.\n\x20The\x20expected\x20syntax\
    \x20for\x20this\x20string\x20is\x20as\x20follows:\n\n\x20DEVICE_SPEC\x20\
    ::=\x20PARTIAL_SPEC\n\n\x20PARTIAL_SPEC\x20::=\x20(\"/\"\x20CONSTRAINT)\
    \x20*\n\x20CONSTRAINT\x20::=\x20(\"job:\"\x20JOB_NAME)\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20|\x20(\"replica:\"\x20[1-9][0-9]\
    *)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20|\x20(\"task\
    :\"\x20[1-9][0-9]*)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20|\x20(\"device:\"\x20[A-Za-z]*\x20\":\"\x20([1-9][0-9]*\x20|\x20\
    ...
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20(partial\
    \x20specification)\n\x20*\x20\"\"\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20(no\x20specification)\n\n\x20If\x20t\
    he\x20constraints\x20do\x20not\x20resolve\x20to\x20a\x20single\x20device\
    \x20(or\x20if\x20this\n\x20field\x20is\x20empty\x20or\x20not\x20present)\
    ,\x20the\x20runtime\x20will\x20attempt\x20to\n\x20choose\x20a\x20device\
    ...
    \x86\x05\x20Operation-specific\x20graph-construction-time\x20configurati\
    on.\n\x20Note\x20that\x20this\x20should\x20include\x20all\x20attrs\x20de\
    fined\x20in\x20the\n\x20corresponding\x20OpDef,\x20including\x20those\
    \x20with\x20a\x20value\x20matching\n\x20the\x20default\x20--\x20this\x20\
    allows\x20the\x20default\x20to\x20change\x20and\x20makes\n\x20NodeDefs\
    \x20easier\x20to\x20interpret\x20on\x20their\x20own.\x20\x20However,\x20\
    if\n\x20an\x20attr\x20with\x20a\x20default\x20is\x20not\x20specified\x20\
    in\x20this\x20list,\x20the\n\x20default\x20will\x20be\x20used.\n\x20The\
    \x20\"names\"\x20(keys)\x20must\x20match\x20the\x20regexp\x20\"[a-z][a-z\
    0-9_]+\"\x20(and\n\x20one\x20of\x20the\x20names\x20from\x20the\x20corres\
    ponding\x20OpDef's\x20attr\x20field).\n\x20The\x20values\x20must\x20have\
    \x20a\x20type\x20matching\x20the\x20corresponding\x20OpDef\n\x20attr's\
    \x20type\x20field.\n\x20TODO(josh11b):\x20Add\x20some\x20examples\x20her\
    e\x20showing\x20best\x20practices.\n\n\x0c\n\x05\x04\0\x02\x04\x06\x12\
    ...
    \x03\x01\x02\0\x12\x03I\x04,\x1a\x93\x03\x20Opaque\x20string\x20inserted\
    \x20into\x20error\x20messages\x20created\x20by\x20the\x20runtime.\n\n\
    \x20This\x20is\x20intended\x20to\x20store\x20the\x20list\x20of\x20names\
    \x20of\x20the\x20nodes\x20from\x20the\n\x20original\x20graph\x20that\x20\
    this\x20node\x20was\x20derived.\x20For\x20example\x20if\x20this\x20node,\
    \x20say\n\x20C,\x20was\x20result\x20of\x20a\x20fusion\x20of\x202\x20node\
    s\x20A\x20and\x20B,\x20then\x20'original_node'\x20would\n\x20be\x20{A,\
    \x20B}.\x20This\x20information\x20can\x20be\x20used\x20to\x20map\x20erro\
    rs\x20originating\x20at\x20the\n\x20current\x20node\x20to\x20some\x20top\
    \x20level\x20source\x20code.\n\n\x0e\n\x07\x04\0\x03\x01\x02\0\x04\x12\
    \x03I\x04\x0c\n\x0e\n\x07\x04\0\x03\x01\x02\0\x05\x12\x03I\r\x13\n\x0e\n\
    \x07\x04\0\x03\x01\x02\0\x01\x12\x03I\x14'\n\x0e\n\x07\x04\0\x03\x01\x02\
    \0\x03\x12\x03I*+\n\xec\x03\n\x06\x04\0\x03\x01\x02\x01\x12\x03R\x04,\
    \x1a\xdc\x03\x20This\x20is\x20intended\x20to\x20store\x20the\x20list\x20\
    of\x20names\x20of\x20the\x20functions\x20from\x20the\n\x20original\x20gr\
    aph\x20that\x20this\x20node\x20was\x20derived.\x20For\x20example\x20if\
    \x20this\x20node,\x20say\n\x20C,\x20was\x20result\x20of\x20a\x20fusion\
    \x20of\x20node\x20A\x20in\x20function\x20FA\x20and\x20node\x20B\x20in\
    \x20function\n\x20FB,\x20then\x20`original_funcs`\x20would\x20be\x20{FA,\
    \x20FB}.\x20If\x20the\x20node\x20is\x20in\x20the\x20top\n\x20level\x20gr\
    aph,\x20the\x20`original_func`\x20is\x20empty.\x20This\x20information,\
    \x20with\x20the\n\x20`original_node_names`\x20can\x20be\x20used\x20to\
    \x20map\x20errors\x20originating\x20at\x20the\n\x20current\x20ndoe\x20to\
    \x20some\x20top\x20level\x20source\x20code.\n\n\x0e\n\x07\x04\0\x03\x01\
    ...
    V\x024\x1a9\x20This\x20stores\x20debug\x20information\x20associated\x20w\
    ith\x20the\x20node.\n\n\x0c\n\x05\x04\0\x02\x05\x06\x12\x03V\x02\x17\n\
    \x0c\n\x05\x04\0\x02\x05\x01\x12\x03V\x18/\n\x0c\n\x05\x04\0\x02\x05\x03\
    \x12\x03V23b\x06proto3\
";
