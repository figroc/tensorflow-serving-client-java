...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x02\x20\x01(\x03R\x07version\"\xeb\x12\n\x0bConfigProto\x12K\n\x0cd\
    ...
    \"\xda\x01\n\x11MlirBridgeRollout\x12#\n\x1fMLIR_BRIDGE_ROLLOUT_UNSPECIF\
    IED\x10\0\x12\x1f\n\x1bMLIR_BRIDGE_ROLLOUT_ENABLED\x10\x01\x12\x20\n\x1c\
    MLIR_BRIDGE_ROLLOUT_DISABLED\x10\x02\x12)\n%MLIR_BRIDGE_ROLLOUT_SAFE_MOD\
    E_ENABLED\x10\x03\x122\n.MLIR_BRIDGE_ROLLOUT_SAFE_MODE_FALLBACK_ENABLED\
    \x10\x04J\x04\x08\x02\x10\x03\"\xa8\x06\n\nRunOptions\x12B\n\x0btrace_le\
    vel\x18\x01\x20\x01(\x0e2!.tensorflow.RunOptions.TraceLevelR\ntraceLevel\
    ...
    \x02\x20\x01(\x08R\x11useRunHandlerPool\x12r\n\x18run_handler_pool_optio\
    ns\x18\x03\x20\x01(\x0b29.tensorflow.RunOptions.Experimental.RunHandlerP\
    oolOptionsR\x15runHandlerPoolOptions\x1a3\n\x15RunHandlerPoolOptions\x12\
    ...
    \x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\x028\x01Bk\n\x18org.tensor\
    flow.frameworkB\x0cConfigProtosP\x01Z<github.com/tensorflow/tensorflow/t\
    ensorflow/go/core/protobuf\xf8\x01\x01J\xad\xa3\x02\n\x07\x12\x05\0\0\
    \xcb\x06\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\
    \0\x13\n\t\n\x02\x03\0\x12\x03\x04\04\n\t\n\x02\x03\x01\x12\x03\x05\0/\n\
    \t\n\x02\x03\x02\x12\x03\x06\04\n\t\n\x02\x03\x03\x12\x03\x07\00\n\t\n\
    \x02\x03\x04\x12\x03\x08\0.\n\t\n\x02\x03\x05\x12\x03\t\08\n\x08\n\x01\
    \x08\x12\x03\x0b\0\x1f\n\t\n\x02\x08\x1f\x12\x03\x0b\0\x1f\n\x08\n\x01\
    \x08\x12\x03\x0c\0-\n\t\n\x02\x08\x08\x12\x03\x0c\0-\n\x08\n\x01\x08\x12\
    \x03\r\0\"\n\t\n\x02\x08\n\x12\x03\r\0\"\n\x08\n\x01\x08\x12\x03\x0e\01\
    \n\t\n\x02\x08\x01\x12\x03\x0e\01\n\x08\n\x01\x08\x12\x03\x0f\0S\n\t\n\
    \x02\x08\x0b\x12\x03\x0f\0S\n\x0b\n\x02\x04\0\x12\x05\x11\0\xcd\x01\x01\
    \n\n\n\x03\x04\0\x01\x12\x03\x11\x08\x12\n\xe2\x07\n\x04\x04\0\x02\0\x12\
    \x03#\x02-\x1a\xd4\x07\x20Fraction\x20of\x20the\x20available\x20GPU\x20m\
    emory\x20to\x20allocate\x20for\x20each\x20process.\n\x201\x20means\x20to\
    \x20allocate\x20all\x20of\x20the\x20GPU\x20memory,\x200.5\x20means\x20th\
    e\x20process\n\x20allocates\x20up\x20to\x20~50%\x20of\x20the\x20availabl\
    e\x20GPU\x20memory.\n\n\x20GPU\x20memory\x20is\x20pre-allocated\x20unles\
    s\x20the\x20allow_growth\x20option\x20is\x20enabled.\n\n\x20If\x20greate\
    r\x20than\x201.0,\x20uses\x20CUDA\x20unified\x20memory\x20to\x20potentia\
    lly\x20oversubscribe\n\x20the\x20amount\x20of\x20memory\x20available\x20\
    on\x20the\x20GPU\x20device\x20by\x20using\x20host\x20memory\x20as\x20a\n\
    \x20swap\x20space.\x20Accessing\x20memory\x20not\x20available\x20on\x20t\
    he\x20device\x20will\x20be\n\x20significantly\x20slower\x20as\x20that\
    \x20would\x20require\x20memory\x20transfer\x20between\x20the\x20host\n\
    \x20and\x20the\x20device.\x20Options\x20to\x20reduce\x20the\x20memory\
    \x20requirement\x20should\x20be\n\x20considered\x20before\x20enabling\
    \x20this\x20option\x20as\x20this\x20may\x20come\x20with\x20a\x20negative\
    \n\x20performance\x20impact.\x20Oversubscription\x20using\x20the\x20unif\
    ied\x20memory\x20requires\n\x20Pascal\x20class\x20or\x20newer\x20GPUs\
    \x20and\x20it\x20is\x20currently\x20only\x20supported\x20on\x20the\x20Li\
    nux\n\x20operating\x20system.\x20See\n\x20https://docs.nvidia.com/cuda/c\
    uda-c-programming-guide/index.html#um-requirements\n\x20for\x20the\x20de\
    tailed\x20requirements.\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03#\x02\x08\n\
    \x0c\n\x05\x04\0\x02\0\x01\x12\x03#\t(\n\x0c\n\x05\x04\0\x02\0\x03\x12\
    \x03#+,\n\x93\x01\n\x04\x04\0\x02\x01\x12\x03'\x02\x18\x1a\x85\x01\x20If\
    \x20true,\x20the\x20allocator\x20does\x20not\x20pre-allocate\x20the\x20e\
    ntire\x20specified\n\x20GPU\x20memory\x20region,\x20instead\x20starting\
    \x20small\x20and\x20growing\x20as\x20needed.\n\n\x0c\n\x05\x04\0\x02\x01\
    \x05\x12\x03'\x02\x06\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03'\x07\x13\n\
    \x0c\n\x05\x04\0\x02\x01\x03\x12\x03'\x16\x17\n\x8b\x02\n\x04\x04\0\x02\
    \x02\x12\x031\x02\x1c\x1a\xfd\x01\x20The\x20type\x20of\x20GPU\x20allocat\
    ion\x20strategy\x20to\x20use.\n\n\x20Allowed\x20values:\n\x20\"\":\x20Th\
    e\x20empty\x20string\x20(default)\x20uses\x20a\x20system-chosen\x20defau\
    lt\n\x20\x20\x20\x20\x20which\x20may\x20change\x20over\x20time.\n\n\x20\
    \"BFC\":\x20A\x20\"Best-fit\x20with\x20coalescing\"\x20algorithm,\x20sim\
    plified\x20from\x20a\n\x20\x20\x20\x20\x20\x20\x20\x20version\x20of\x20d\
    lmalloc.\n\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x031\x02\x08\n\x0c\n\x05\
    \x04\0\x02\x02\x01\x12\x031\t\x17\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x031\
    \x1a\x1b\n\xb2\x01\n\x04\x04\0\x02\x03\x12\x036\x02$\x1a\xa4\x01\x20Dela\
    y\x20deletion\x20of\x20up\x20to\x20this\x20many\x20bytes\x20to\x20reduce\
    \x20the\x20number\x20of\n\x20interactions\x20with\x20gpu\x20driver\x20co\
    de.\x20\x20If\x200,\x20the\x20system\x20chooses\n\x20a\x20reasonable\x20\
    default\x20(several\x20MBs).\n\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x036\
    \x02\x07\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x036\x08\x1f\n\x0c\n\x05\x04\
    \0\x02\x03\x03\x12\x036\"#\n\xdc\t\n\x04\x04\0\x02\x04\x12\x03M\x02!\x1a\
    \xce\t\x20A\x20comma-separated\x20list\x20of\x20GPU\x20ids\x20that\x20de\
    termines\x20the\x20'visible'\n\x20to\x20'virtual'\x20mapping\x20of\x20GP\
    U\x20devices.\x20\x20For\x20example,\x20if\x20TensorFlow\n\x20can\x20see\
    \x208\x20GPU\x20devices\x20in\x20the\x20process,\x20and\x20one\x20wanted\
    \x20to\x20map\n\x20visible\x20GPU\x20devices\x205\x20and\x203\x20as\x20\
    \"/device:GPU:0\",\x20and\x20\"/device:GPU:1\",\n\x20then\x20one\x20woul\
    d\x20specify\x20this\x20field\x20as\x20\"5,3\".\x20\x20This\x20field\x20\
    is\x20similar\x20in\n\x20spirit\x20to\x20the\x20CUDA_VISIBLE_DEVICES\x20\
    environment\x20variable,\x20except\n\x20it\x20applies\x20to\x20the\x20vi\
    sible\x20GPU\x20devices\x20in\x20the\x20process.\n\n\x20NOTE:\n\x201.\
    \x20The\x20GPU\x20driver\x20provides\x20the\x20process\x20with\x20the\
    \x20visible\x20GPUs\n\x20\x20\x20\x20in\x20an\x20order\x20which\x20is\
    \x20not\x20guaranteed\x20to\x20have\x20any\x20correlation\x20to\n\x20\
    \x20\x20\x20the\x20*physical*\x20GPU\x20id\x20in\x20the\x20machine.\x20\
    \x20This\x20field\x20is\x20used\x20for\n\x20\x20\x20\x20remapping\x20\"v\
    isible\"\x20to\x20\"virtual\",\x20which\x20means\x20this\x20operates\x20\
    only\n\x20\x20\x20\x20after\x20the\x20process\x20starts.\x20\x20Users\
    \x20are\x20required\x20to\x20use\x20vendor\n\x20\x20\x20\x20specific\x20\
    mechanisms\x20(e.g.,\x20CUDA_VISIBLE_DEVICES)\x20to\x20control\x20the\n\
    \x20\x20\x20\x20physical\x20to\x20visible\x20device\x20mapping\x20prior\
    \x20to\x20invoking\x20TensorFlow.\n\x202.\x20In\x20the\x20code,\x20the\
    \x20ids\x20in\x20this\x20list\x20are\x20also\x20called\x20\"platform\x20\
    GPU\x20id\"s,\n\x20\x20\x20\x20and\x20the\x20'virtual'\x20ids\x20of\x20G\
    PU\x20devices\x20(i.e.\x20the\x20ids\x20in\x20the\x20device\n\x20\x20\
    \x20\x20name\x20\"/device:GPU:<id>\")\x20are\x20also\x20called\x20\"TF\
    \x20GPU\x20id\"s.\x20Please\n\x20\x20\x20\x20refer\x20to\x20third_party/\
    tensorflow/core/common_runtime/gpu/gpu_id.h\n\x20\x20\x20\x20for\x20more\
    \x20information.\n\n\x0c\n\x05\x04\0\x02\x04\x05\x12\x03M\x02\x08\n\x0c\
    \n\x05\x04\0\x02\x04\x01\x12\x03M\t\x1c\n\x0c\n\x05\x04\0\x02\x04\x03\
    \x12\x03M\x1f\x20\n\xc1\x01\n\x04\x04\0\x02\x05\x12\x03R\x02'\x1a\xb3\
    ...
    \x02\x05\x01\x12\x03R\x08\"\n\x0c\n\x05\x04\0\x02\x05\x03\x12\x03R%&\n4\
    \n\x04\x04\0\x02\x06\x12\x03U\x02)\x1a'\x20This\x20field\x20is\x20deprec\
    ated\x20and\x20ignored.\n\n\x0c\n\x05\x04\0\x02\x06\x05\x12\x03U\x02\x07\
    \n\x0c\n\x05\x04\0\x02\x06\x01\x12\x03U\x08$\n\x0c\n\x05\x04\0\x02\x06\
    \x03\x12\x03U'(\n\x9a\x05\n\x04\x04\0\x02\x07\x12\x03a\x02\x20\x1a\x8c\
    \x05\x20Force\x20all\x20tensors\x20to\x20be\x20gpu_compatible.\x20On\x20\
    a\x20GPU-enabled\x20TensorFlow,\n\x20enabling\x20this\x20option\x20force\
    s\x20all\x20CPU\x20tensors\x20to\x20be\x20allocated\x20with\x20Cuda\n\
    \x20pinned\x20memory.\x20Normally,\x20TensorFlow\x20will\x20infer\x20whi\
    ch\x20tensors\x20should\x20be\n\x20allocated\x20as\x20the\x20pinned\x20m\
    emory.\x20But\x20in\x20case\x20where\x20the\x20inference\x20is\n\x20inco\
    mplete,\x20this\x20option\x20can\x20significantly\x20speed\x20up\x20the\
    \x20cross-device\x20memory\n\x20copy\x20performance\x20as\x20long\x20as\
    \x20it\x20fits\x20the\x20memory.\n\x20Note\x20that\x20this\x20option\x20\
    is\x20not\x20something\x20that\x20should\x20be\n\x20enabled\x20by\x20def\
    ault\x20for\x20unknown\x20or\x20very\x20large\x20models,\x20since\x20all\
    \x20Cuda\x20pinned\n\x20memory\x20is\x20unpageable,\x20having\x20too\x20\
    much\x20pinned\x20memory\x20might\x20negatively\x20impact\n\x20the\x20ov\
    erall\x20host\x20system\x20performance.\n\n\x0c\n\x05\x04\0\x02\x07\x05\
    \x12\x03a\x02\x06\n\x0c\n\x05\x04\0\x02\x07\x01\x12\x03a\x07\x1b\n\x0c\n\
    \x05\x04\0\x02\x07\x03\x12\x03a\x1e\x1f\n\r\n\x04\x04\0\x03\0\x12\x05c\
    \x02\xc7\x01\x03\n\x0c\n\x05\x04\0\x03\0\x01\x12\x03c\n\x16\na\n\x06\x04\
    \0\x03\0\x03\0\x12\x04f\x04|\x05\x1aQ\x20Configuration\x20for\x20breakin\
    g\x20down\x20a\x20visible\x20GPU\x20into\x20multiple\x20\"virtual\"\n\
    \x20devices.\n\n\x0e\n\x07\x04\0\x03\0\x03\0\x01\x12\x03f\x0c\x1a\n\xa5\
    \x03\n\x08\x04\0\x03\0\x03\0\x02\0\x12\x03o\x06)\x1a\x93\x03\x20Per\x20\
    \"virtual\"\x20device\x20memory\x20limit,\x20in\x20MB.\x20The\x20number\
    \x20of\x20elements\x20in\n\x20the\x20list\x20is\x20the\x20number\x20of\
    \x20virtual\x20devices\x20to\x20create\x20on\x20the\n\x20corresponding\
    \x20visible\x20GPU\x20(see\x20\"virtual_devices\"\x20below).\n\x20If\x20\
    empty,\x20it\x20will\x20create\x20single\x20virtual\x20device\x20taking\
    \x20all\x20available\n\x20memory\x20from\x20the\x20device.\n\n\x20For\
    \x20the\x20concept\x20of\x20\"visible\"\x20and\x20\"virtual\"\x20GPU,\
    \x20see\x20the\x20comments\x20for\n\x20\"visible_device_list\"\x20above\
    \x20for\x20more\x20information.\n\n\x10\n\t\x04\0\x03\0\x03\0\x02\0\x04\
    \x12\x03o\x06\x0e\n\x10\n\t\x04\0\x03\0\x03\0\x02\0\x05\x12\x03o\x0f\x14\
    \n\x10\n\t\x04\0\x03\0\x03\0\x02\0\x01\x12\x03o\x15$\n\x10\n\t\x04\0\x03\
    \0\x03\0\x02\0\x03\x12\x03o'(\n\xe1\x03\n\x08\x04\0\x03\0\x03\0\x02\x01\
    \x12\x03{\x06\"\x1a\xcf\x03\x20Priority\x20values\x20to\x20use\x20with\
    \x20the\x20virtual\x20devices.\x20Use\x20the\x20cuda\x20function\n\x20cu\
    daDeviceGetStreamPriorityRange\x20to\x20query\x20for\x20valid\x20range\
    \x20of\x20values\x20for\n\x20priority.\n\n\x20On\x20a\x20P4000\x20GPU\
    \x20with\x20cuda\x2010.1,\x20the\x20priority\x20range\x20reported\x20was\
    \x200\x20for\n\x20least\x20priority\x20and\x20-1\x20for\x20greatest\x20p\
    riority.\n\n\x20If\x20this\x20field\x20is\x20not\x20specified,\x20then\
    \x20the\x20virtual\x20devices\x20will\x20be\n\x20created\x20with\x20the\
    \x20default.\x20If\x20this\x20field\x20has\x20values\x20set,\x20then\x20\
    the\x20size\n\x20of\x20this\x20must\x20match\x20with\x20the\x20above\x20\
    memory_limit_mb.\n\n\x10\n\t\x04\0\x03\0\x03\0\x02\x01\x04\x12\x03{\x06\
    \x0e\n\x10\n\t\x04\0\x03\0\x03\0\x02\x01\x05\x12\x03{\x0f\x14\n\x10\n\t\
    \x04\0\x03\0\x03\0\x02\x01\x01\x12\x03{\x15\x1d\n\x10\n\t\x04\0\x03\0\
    \x03\0\x02\x01\x03\x12\x03{\x20!\n\xae\t\n\x06\x04\0\x03\0\x02\0\x12\x04\
    \x95\x01\x040\x1a\x9d\t\x20The\x20multi\x20virtual\x20device\x20settings\
    ...
    \x95\x01\x04\x0c\n\x0f\n\x07\x04\0\x03\0\x02\0\x06\x12\x04\x95\x01\r\x1b\
    \n\x0f\n\x07\x04\0\x03\0\x02\0\x01\x12\x04\x95\x01\x1c+\n\x0f\n\x07\x04\
    \0\x03\0\x02\0\x03\x12\x04\x95\x01./\n\xe6\x03\n\x06\x04\0\x03\0\x02\x01\
    \x12\x04\x9e\x01\x04\x20\x1a\xd5\x03\x20If\x20true,\x20uses\x20CUDA\x20u\
    ...
    \x0f\n\x07\x04\0\x03\0\x02\x01\x05\x12\x04\x9e\x01\x04\x08\n\x0f\n\x07\
    \x04\0\x03\0\x02\x01\x01\x12\x04\x9e\x01\t\x1b\n\x0f\n\x07\x04\0\x03\0\
    \x02\x01\x03\x12\x04\x9e\x01\x1e\x1f\n\xa2\x01\n\x06\x04\0\x03\0\x02\x02\
    \x12\x04\xa3\x01\x04*\x1a\x91\x01\x20If\x20>\x201,\x20the\x20number\x20o\
    f\x20device-to-device\x20copy\x20streams\x20to\x20create\n\x20for\x20eac\
    h\x20GPUDevice.\x20\x20Default\x20value\x20is\x200,\x20which\x20is\x20au\
    tomatically\n\x20converted\x20to\x201.\n\n\x0f\n\x07\x04\0\x03\0\x02\x02\
    \x05\x12\x04\xa3\x01\x04\t\n\x0f\n\x07\x04\0\x03\0\x02\x02\x01\x12\x04\
    \xa3\x01\n%\n\x0f\n\x07\x04\0\x03\0\x02\x02\x03\x12\x04\xa3\x01()\n\xb4\
    \x03\n\x06\x04\0\x03\0\x02\x03\x12\x04\xab\x01\x04%\x1a\xa3\x03\x20If\
    \x20non-empty,\x20defines\x20a\x20good\x20GPU\x20ring\x20order\x20on\x20\
    a\x20single\x20worker\x20based\x20on\n\x20device\x20interconnect.\x20\
    \x20This\x20assumes\x20that\x20all\x20workers\x20have\x20the\x20same\x20\
    GPU\n\x20topology.\x20\x20Specify\x20as\x20a\x20comma-separated\x20strin\
    g,\x20e.g.\x20\"3,2,1,0,7,6,5,4\".\n\x20This\x20ring\x20order\x20is\x20u\
    sed\x20by\x20the\x20RingReducer\x20implementation\x20of\n\x20CollectiveR\
    educe,\x20and\x20serves\x20as\x20an\x20override\x20to\x20automatic\x20ri\
    ng\x20order\n\x20generation\x20in\x20OrderTaskDeviceMap()\x20during\x20C\
    ollectiveParam\x20resolution.\n\n\x0f\n\x07\x04\0\x03\0\x02\x03\x05\x12\
    \x04\xab\x01\x04\n\n\x0f\n\x07\x04\0\x03\0\x02\x03\x01\x12\x04\xab\x01\
    \x0b\x20\n\x0f\n\x07\x04\0\x03\0\x02\x03\x03\x12\x04\xab\x01#$\n\x80\x02\
    \n\x06\x04\0\x03\0\x02\x04\x12\x04\xb1\x01\x04#\x1a\xef\x01\x20If\x20tru\
    e\x20then\x20extra\x20work\x20is\x20done\x20by\x20GPUDevice\x20and\x20GP\
    UBFCAllocator\x20to\n\x20keep\x20track\x20of\x20when\x20GPU\x20memory\
    \x20is\x20freed\x20and\x20when\x20kernels\x20actually\n\x20complete\x20s\
    o\x20that\x20we\x20can\x20know\x20when\x20a\x20nominally\x20free\x20memo\
    ry\x20chunk\n\x20is\x20really\x20not\x20subject\x20to\x20pending\x20use.\
    \n\n\x0f\n\x07\x04\0\x03\0\x02\x04\x05\x12\x04\xb1\x01\x04\x08\n\x0f\n\
    \x07\x04\0\x03\0\x02\x04\x01\x12\x04\xb1\x01\t\x1e\n\x0f\n\x07\x04\0\x03\
    \0\x02\x04\x03\x12\x04\xb1\x01!\"\n\xb5\x02\n\x06\x04\0\x03\0\x02\x05\
    \x12\x04\xbb\x01\x04*\x1a\x92\x02\x20Parameters\x20for\x20GPUKernelTrack\
    er.\x20\x20By\x20default\x20no\x20kernel\x20tracking\x20is\x20done.\n\
    \x20Note\x20that\x20timestamped_allocator\x20is\x20only\x20effective\x20\
    if\x20some\x20tracking\x20is\n\x20specified.\n\n\x20If\x20kernel_tracker\
    _max_interval\x20=\x20n\x20>\x200,\x20then\x20a\x20tracking\x20event\n\
    \x20is\x20inserted\x20after\x20every\x20n\x20kernels\x20without\x20an\
    \x20event.\n2\x10\x20reserved\x20id:\x206\n\n\x0f\n\x07\x04\0\x03\0\x02\
    \x05\x05\x12\x04\xbb\x01\x04\t\n\x0f\n\x07\x04\0\x03\0\x02\x05\x01\x12\
    \x04\xbb\x01\n%\n\x0f\n\x07\x04\0\x03\0\x02\x05\x03\x12\x04\xbb\x01()\n\
    \x9e\x02\n\x06\x04\0\x03\0\x02\x06\x12\x04\xc1\x01\x04'\x1a\x8d\x02\x20I\
    f\x20kernel_tracker_max_bytes\x20=\x20n\x20>\x200,\x20then\x20a\x20track\
    ing\x20event\x20is\n\x20inserted\x20after\x20every\x20series\x20of\x20ke\
    rnels\x20allocating\x20a\x20sum\x20of\n\x20memory\x20>=\x20n.\x20\x20If\
    \x20one\x20kernel\x20allocates\x20b\x20*\x20n\x20bytes,\x20then\x20one\n\
    \x20event\x20will\x20be\x20inserted\x20after\x20it,\x20but\x20it\x20will\
    \x20count\x20as\x20b\x20against\n\x20the\x20pending\x20limit.\n\n\x0f\n\
    \x07\x04\0\x03\0\x02\x06\x05\x12\x04\xc1\x01\x04\t\n\x0f\n\x07\x04\0\x03\
    \0\x02\x06\x01\x12\x04\xc1\x01\n\"\n\x0f\n\x07\x04\0\x03\0\x02\x06\x03\
    \x12\x04\xc1\x01%&\n\xd1\x01\n\x06\x04\0\x03\0\x02\x07\x12\x04\xc6\x01\
    \x04)\x1a\xc0\x01\x20If\x20kernel_tracker_max_pending\x20>\x200\x20then\
    \x20no\x20more\x20than\x20this\x20many\n\x20tracking\x20events\x20can\
    \x20be\x20outstanding\x20at\x20a\x20time.\x20\x20An\x20attempt\x20to\n\
    \x20launch\x20an\x20additional\x20kernel\x20will\x20stall\x20until\x20an\
    \x20event\n\x20completes.\n\n\x0f\n\x07\x04\0\x03\0\x02\x07\x05\x12\x04\
    \xc6\x01\x04\t\n\x0f\n\x07\x04\0\x03\0\x02\x07\x01\x12\x04\xc6\x01\n$\n\
    \x0f\n\x07\x04\0\x03\0\x02\x07\x03\x12\x04\xc6\x01'(\n\xa9\x01\n\x04\x04\
    \0\x02\x08\x12\x04\xcc\x01\x02\x20\x1a\x9a\x01\x20Everything\x20inside\
    ...
    \x12\x04\xcc\x01\x02\x0e\n\r\n\x05\x04\0\x02\x08\x01\x12\x04\xcc\x01\x0f\
    \x1b\n\r\n\x05\x04\0\x02\x08\x03\x12\x04\xcc\x01\x1e\x1f\n5\n\x02\x04\
    \x01\x12\x06\xd0\x01\0\xfd\x01\x01\x1a'\x20Options\x20passed\x20to\x20th\
    e\x20graph\x20optimizer\n\n\x0b\n\x03\x04\x01\x01\x12\x04\xd0\x01\x08\
    \x18\nS\n\x04\x04\x01\x02\0\x12\x04\xd2\x01\x02/\x1aE\x20If\x20true,\x20\
    optimize\x20the\x20graph\x20using\x20common\x20subexpression\x20eliminat\
    ion.\n\n\r\n\x05\x04\x01\x02\0\x05\x12\x04\xd2\x01\x02\x06\n\r\n\x05\x04\
    \x01\x02\0\x01\x12\x04\xd2\x01\x07*\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\
    \xd2\x01-.\nL\n\x04\x04\x01\x02\x01\x12\x04\xd5\x01\x02\x1f\x1a>\x20If\
    \x20true,\x20perform\x20constant\x20folding\x20optimization\x20on\x20the\
    \x20graph.\n\n\r\n\x05\x04\x01\x02\x01\x05\x12\x04\xd5\x01\x02\x06\n\r\n\
    \x05\x04\x01\x02\x01\x01\x12\x04\xd5\x01\x07\x1a\n\r\n\x05\x04\x01\x02\
    \x01\x03\x12\x04\xd5\x01\x1d\x1e\n\xdc\x02\n\x04\x04\x01\x02\x02\x12\x04\
    \xdc\x01\x02)\x1a\xcd\x02\x20Constant\x20folding\x20optimization\x20repl\
    aces\x20tensors\x20whose\x20values\x20can\x20be\n\x20predetermined,\x20w\
    ith\x20constant\x20nodes.\x20To\x20avoid\x20inserting\x20too\x20large\
    \x20constants,\n\x20the\x20size\x20of\x20each\x20constant\x20created\x20\
    can\x20be\x20limited.\x20If\x20this\x20value\x20is\x20zero,\x20a\n\x20de\
    fault\x20limit\x20of\x2010\x20MiB\x20will\x20be\x20applied.\x20If\x20con\
    stant\x20folding\x20optimization\n\x20is\x20disabled,\x20this\x20value\
    \x20is\x20ignored.\n\n\r\n\x05\x04\x01\x02\x02\x05\x12\x04\xdc\x01\x02\
    \x07\n\r\n\x05\x04\x01\x02\x02\x01\x12\x04\xdc\x01\x08$\n\r\n\x05\x04\
    \x01\x02\x02\x03\x12\x04\xdc\x01'(\n@\n\x04\x04\x01\x02\x03\x12\x04\xdf\
    \x01\x02\x20\x1a2\x20If\x20true,\x20perform\x20function\x20inlining\x20o\
    n\x20the\x20graph.\n\n\r\n\x05\x04\x01\x02\x03\x05\x12\x04\xdf\x01\x02\
    \x06\n\r\n\x05\x04\x01\x02\x03\x01\x12\x04\xdf\x01\x07\x1b\n\r\n\x05\x04\
    \x01\x02\x03\x03\x12\x04\xdf\x01\x1e\x1f\n$\n\x04\x04\x01\x04\0\x12\x06\
    \xe2\x01\x02\xeb\x01\x03\x1a\x14\x20Optimization\x20level\n\n\r\n\x05\
    \x04\x01\x04\0\x01\x12\x04\xe2\x01\x07\x0c\n\x84\x01\n\x06\x04\x01\x04\0\
    \x02\0\x12\x04\xe7\x01\x04\x0b\x1at\x20L1\x20is\x20the\x20default\x20lev\
    el.\n\x20Optimization\x20performed\x20at\x20L1\x20:\n\x201.\x20Common\
    \x20subexpression\x20elimination\n\x202.\x20Constant\x20folding\n\n\x0f\
    \n\x07\x04\x01\x04\0\x02\0\x01\x12\x04\xe7\x01\x04\x06\n\x0f\n\x07\x04\
    \x01\x04\0\x02\0\x02\x12\x04\xe7\x01\t\n\n\"\n\x06\x04\x01\x04\0\x02\x01\
    \x12\x04\xea\x01\x04\x0c\x1a\x12\x20No\x20optimizations\n\n\x0f\n\x07\
    \x04\x01\x04\0\x02\x01\x01\x12\x04\xea\x01\x04\x06\n\x0f\n\x07\x04\x01\
    \x04\0\x02\x01\x02\x12\x04\xea\x01\t\x0b\n\xa5\x01\n\x04\x04\x01\x02\x04\
    \x12\x04\xef\x01\x02\x16\x1a\x96\x01\x20Overall\x20optimization\x20level\
    .\x20The\x20actual\x20optimizations\x20applied\x20will\x20be\x20the\n\
    \x20logical\x20OR\x20of\x20the\x20flags\x20that\x20this\x20level\x20impl\
    ies\x20and\x20any\x20flags\x20already\x20set.\n\n\r\n\x05\x04\x01\x02\
    \x04\x06\x12\x04\xef\x01\x02\x07\n\r\n\x05\x04\x01\x02\x04\x01\x12\x04\
    \xef\x01\x08\x11\n\r\n\x05\x04\x01\x02\x04\x03\x12\x04\xef\x01\x14\x15\n\
    E\n\x04\x04\x01\x04\x01\x12\x06\xf2\x01\x02\xfb\x01\x03\x1a5\x20Control\
    \x20the\x20use\x20of\x20the\x20compiler/jit.\x20\x20Experimental.\n\n\r\
    \n\x05\x04\x01\x04\x01\x01\x12\x04\xf2\x01\x07\x15\nL\n\x06\x04\x01\x04\
    \x01\x02\0\x12\x04\xf3\x01\x04\x10\"<\x20Default\x20setting\x20(\"off\"\
    \x20now,\x20but\x20later\x20expected\x20to\x20be\x20\"on\")\n\n\x0f\n\
    \x07\x04\x01\x04\x01\x02\0\x01\x12\x04\xf3\x01\x04\x0b\n\x0f\n\x07\x04\
    \x01\x04\x01\x02\0\x02\x12\x04\xf3\x01\x0e\x0f\n\x0e\n\x06\x04\x01\x04\
    \x01\x02\x01\x12\x04\xf4\x01\x04\r\n\x0f\n\x07\x04\x01\x04\x01\x02\x01\
    \x01\x12\x04\xf4\x01\x04\x07\n\x0f\n\x07\x04\x01\x04\x01\x02\x01\x02\x12\
    \x04\xf4\x01\n\x0c\n\x84\x02\n\x06\x04\x01\x04\x01\x02\x02\x12\x04\xf9\
    \x01\x04\r\x1a\xf3\x01\x20The\x20following\x20settings\x20turn\x20on\x20\
    compilation,\x20with\x20higher\x20values\x20being\n\x20more\x20aggressiv\
    e.\x20\x20Higher\x20values\x20may\x20reduce\x20opportunities\x20for\x20p\
    arallelism\n\x20and\x20may\x20use\x20more\x20memory.\x20\x20(At\x20prese\
    nt,\x20there\x20is\x20no\x20distinction,\x20but\x20this\n\x20is\x20expec\
    ted\x20to\x20change.)\n\n\x0f\n\x07\x04\x01\x04\x01\x02\x02\x01\x12\x04\
    \xf9\x01\x04\x08\n\x0f\n\x07\x04\x01\x04\x01\x02\x02\x02\x12\x04\xf9\x01\
    \x0b\x0c\n\x0e\n\x06\x04\x01\x04\x01\x02\x03\x12\x04\xfa\x01\x04\r\n\x0f\
    \n\x07\x04\x01\x04\x01\x02\x03\x01\x12\x04\xfa\x01\x04\x08\n\x0f\n\x07\
    \x04\x01\x04\x01\x02\x03\x02\x12\x04\xfa\x01\x0b\x0c\n\x0c\n\x04\x04\x01\
    \x02\x05\x12\x04\xfc\x01\x02&\n\r\n\x05\x04\x01\x02\x05\x06\x12\x04\xfc\
    \x01\x02\x10\n\r\n\x05\x04\x01\x02\x05\x01\x12\x04\xfc\x01\x11!\n\r\n\
    \x05\x04\x01\x02\x05\x03\x12\x04\xfc\x01$%\n\x0c\n\x02\x04\x02\x12\x06\
    \xff\x01\0\xac\x02\x01\n\x0b\n\x03\x04\x02\x01\x12\x04\xff\x01\x08\x14\n\
    4\n\x03\x04\x02\n\x12\x04\x81\x02\x023\x1a'\x20Removed,\x20use\x20optimi\
    zer_options\x20below.\n\n\x0c\n\x04\x04\x02\n\0\x12\x04\x81\x02\x0b2\n\
    \x0b\n\x03\x04\x02\t\x12\x04\x82\x02\x02\r\n\x0c\n\x04\x04\x02\t\0\x12\
    \x04\x82\x02\x0b\x0c\n\r\n\x05\x04\x02\t\0\x01\x12\x04\x82\x02\x0b\x0c\n\
    \r\n\x05\x04\x02\t\0\x02\x12\x04\x82\x02\x0b\x0c\ni\n\x04\x04\x02\x02\0\
    \x12\x04\x86\x02\x02\"\x1a[\x20If\x20true,\x20use\x20control\x20flow\x20\
    to\x20schedule\x20the\x20activation\x20of\x20Recv\x20nodes.\n\x20(Curren\
    tly\x20ignored.)\n\n\r\n\x05\x04\x02\x02\0\x05\x12\x04\x86\x02\x02\x06\n\
    \r\n\x05\x04\x02\x02\0\x01\x12\x04\x86\x02\x07\x1d\n\r\n\x05\x04\x02\x02\
    \0\x03\x12\x04\x86\x02\x20!\n;\n\x04\x04\x02\x02\x01\x12\x04\x89\x02\x02\
    )\x1a-\x20Options\x20controlling\x20how\x20graph\x20is\x20optimized.\n\n\
    \r\n\x05\x04\x02\x02\x01\x06\x12\x04\x89\x02\x02\x12\n\r\n\x05\x04\x02\
    \x02\x01\x01\x12\x04\x89\x02\x13$\n\r\n\x05\x04\x02\x02\x01\x03\x12\x04\
    \x89\x02'(\n\xa8\x01\n\x04\x04\x02\x02\x02\x12\x04\x8e\x02\x02\x1d\x1a\
    ...
    \x8e\x02\x02\x07\n\r\n\x05\x04\x02\x02\x02\x01\x12\x04\x8e\x02\x08\x18\n\
    \r\n\x05\x04\x02\x02\x02\x03\x12\x04\x8e\x02\x1b\x1c\n]\n\x04\x04\x02\
    \x02\x03\x12\x04\x92\x02\x02#\x1aO\x20The\x20number\x20of\x20steps\x20to\
    \x20skip\x20before\x20collecting\x20statistics\x20for\x20the\n\x20cost\
    \x20model.\n\n\r\n\x05\x04\x02\x02\x03\x05\x12\x04\x92\x02\x02\x07\n\r\n\
    \x05\x04\x02\x02\x03\x01\x12\x04\x92\x02\x08\x1e\n\r\n\x05\x04\x02\x02\
    \x03\x03\x12\x04\x92\x02!\"\nk\n\x04\x04\x02\x02\x04\x12\x04\x96\x02\x02\
    \x18\x1a]\x20Annotate\x20each\x20Node\x20with\x20Op\x20output\x20shape\
    \x20data,\x20to\x20the\x20extent\x20it\x20can\n\x20be\x20statically\x20i\
    nferred.\n\n\r\n\x05\x04\x02\x02\x04\x05\x12\x04\x96\x02\x02\x06\n\r\n\
    \x05\x04\x02\x02\x04\x01\x12\x04\x96\x02\x07\x13\n\r\n\x05\x04\x02\x02\
    \x04\x03\x12\x04\x96\x02\x16\x17\n\xee\x02\n\x04\x04\x02\x02\x05\x12\x04\
    \x9f\x02\x02\x1e\x1a\xdf\x02\x20Only\x20place\x20the\x20subgraphs\x20tha\
    t\x20are\x20run,\x20rather\x20than\x20the\x20entire\x20graph.\n\n\x20Thi\
    s\x20is\x20useful\x20for\x20interactive\x20graph\x20building,\x20where\
    \x20one\x20might\n\x20produce\x20graphs\x20that\x20cannot\x20be\x20place\
    d\x20during\x20the\x20debugging\n\x20process.\x20\x20In\x20particular,\
    \x20it\x20allows\x20the\x20client\x20to\x20continue\x20work\x20in\n\x20a\
    \x20session\x20after\x20adding\x20a\x20node\x20to\x20a\x20graph\x20whose\
    \x20placement\n\x20constraints\x20are\x20unsatisfiable.\n\n\r\n\x05\x04\
    \x02\x02\x05\x05\x12\x04\x9f\x02\x02\x06\n\r\n\x05\x04\x02\x02\x05\x01\
    \x12\x04\x9f\x02\x07\x19\n\r\n\x05\x04\x02\x02\x05\x03\x12\x04\x9f\x02\
    \x1c\x1d\nM\n\x04\x04\x02\x02\x06\x12\x04\xa2\x02\x02$\x1a?\x20If\x20tru\
    e,\x20transfer\x20float\x20values\x20between\x20processes\x20as\x20bfloa\
    t16.\n\n\r\n\x05\x04\x02\x02\x06\x05\x12\x04\xa2\x02\x02\x06\n\r\n\x05\
    \x04\x02\x02\x06\x01\x12\x04\xa2\x02\x07\x1f\n\r\n\x05\x04\x02\x02\x06\
    \x03\x12\x04\xa2\x02\"#\n~\n\x04\x04\x02\x02\x07\x12\x04\xa6\x02\x02\x1a\
    \x1ap\x20If\x20>\x200,\x20record\x20a\x20timeline\x20every\x20this\x20ma\
    ny\x20steps.\n\x20EXPERIMENTAL:\x20This\x20currently\x20has\x20no\x20eff\
    ect\x20in\x20MasterSession.\n\n\r\n\x05\x04\x02\x02\x07\x05\x12\x04\xa6\
    \x02\x02\x07\n\r\n\x05\x04\x02\x02\x07\x01\x12\x04\xa6\x02\x08\x15\n\r\n\
    \x05\x04\x02\x02\x07\x03\x12\x04\xa6\x02\x18\x19\n\xd8\x01\n\x04\x04\x02\
    \x02\x08\x12\x04\xab\x02\x02&\x1a\xc9\x01\x20Options\x20that\x20control\
    \x20the\x20type\x20and\x20amount\x20of\x20graph\x20rewriting.\n\x20Not\
    \x20currently\x20configurable\x20via\x20the\x20public\x20Python\x20API\
    \x20(i.e.\x20there\x20is\x20no\x20API\n\x20stability\x20guarantee\x20if\
    \x20you\x20import\x20RewriterConfig\x20explicitly).\n\n\r\n\x05\x04\x02\
    \x02\x08\x06\x12\x04\xab\x02\x02\x10\n\r\n\x05\x04\x02\x02\x08\x01\x12\
    \x04\xab\x02\x11\x20\n\r\n\x05\x04\x02\x02\x08\x03\x12\x04\xab\x02#%\n\
    \x0c\n\x02\x04\x03\x12\x06\xae\x02\0\xc5\x02\x01\n\x0b\n\x03\x04\x03\x01\
    \x12\x04\xae\x02\x08\x1d\n\xbb\x01\n\x04\x04\x03\x02\0\x12\x04\xb3\x02\
    \x02\x18\x1a\xac\x01\x20The\x20number\x20of\x20threads\x20in\x20the\x20p\
    ool.\n\n\x200\x20means\x20the\x20system\x20picks\x20a\x20value\x20based\
    \x20on\x20where\x20this\x20option\x20proto\x20is\x20used\n\x20(see\x20th\
    e\x20declaration\x20of\x20the\x20specific\x20field\x20for\x20more\x20inf\
    o).\n\n\r\n\x05\x04\x03\x02\0\x05\x12\x04\xb3\x02\x02\x07\n\r\n\x05\x04\
    \x03\x02\0\x01\x12\x04\xb3\x02\x08\x13\n\r\n\x05\x04\x03\x02\0\x03\x12\
    \x04\xb3\x02\x16\x17\n\xf7\x05\n\x04\x04\x03\x02\x01\x12\x04\xc4\x02\x02\
    ...
    garbage\x20collected.\n\n\r\n\x05\x04\x03\x02\x01\x05\x12\x04\xc4\x02\
    \x02\x08\n\r\n\x05\x04\x03\x02\x01\x01\x12\x04\xc4\x02\t\x14\n\r\n\x05\
    \x04\x03\x02\x01\x03\x12\x04\xc4\x02\x17\x18\n\x0c\n\x02\x04\x04\x12\x06\
    \xc7\x02\0\xe0\x02\x01\n\x0b\n\x03\x04\x04\x01\x12\x04\xc7\x02\x08\x12\n\
    \x88\x02\n\x04\x04\x04\x02\0\x12\x04\xcd\x02\x02(\x1a\xf9\x01\x20If\x20t\
    ...
    \n\r\n\x05\x04\x04\x02\0\x05\x12\x04\xcd\x02\x02\x06\n\r\n\x05\x04\x04\
    \x02\0\x01\x12\x04\xcd\x02\x07#\n\r\n\x05\x04\x04\x02\0\x03\x12\x04\xcd\
    \x02&'\nO\n\x04\x04\x04\x02\x01\x12\x04\xd0\x02\x02#\x1aA\x20The\x20comp\
    ression\x20algorithm\x20to\x20be\x20used.\x20One\x20of\x20\"deflate\",\
    \x20\"gzip\".\n\n\r\n\x05\x04\x04\x02\x01\x05\x12\x04\xd0\x02\x02\x08\n\
    \r\n\x05\x04\x04\x02\x01\x01\x12\x04\xd0\x02\t\x1e\n\r\n\x05\x04\x04\x02\
    \x01\x03\x12\x04\xd0\x02!\"\nu\n\x04\x04\x04\x02\x02\x12\x04\xd4\x02\x02\
    \x1e\x1ag\x20If\x20compression_algorithm\x20is\x20set,\x20the\x20compres\
    sion\x20level\x20to\x20be\x20used.\n\x20From\x200\x20(no\x20compression)\
    ,\x20up\x20to\x203.\n\n\r\n\x05\x04\x04\x02\x02\x05\x12\x04\xd4\x02\x02\
    \x07\n\r\n\x05\x04\x04\x02\x02\x01\x12\x04\xd4\x02\x08\x19\n\r\n\x05\x04\
    \x04\x02\x02\x03\x12\x04\xd4\x02\x1c\x1d\n\xc3\x03\n\x04\x04\x04\x02\x03\
    \x12\x04\xdc\x02\x02\x1e\x1a\xb4\x03\x20Setting\x20cache_rpc_response\
    \x20to\x20true\x20will\x20enable\x20sender\x20side\x20caching\x20of\n\
    \x20response\x20for\x20RecvTensorAsync\x20and\x20RecvBufAsync\x20to\x20a\
    llow\x20receiver\x20to\x20retry\n\x20requests\x20.\x20This\x20is\x20only\
    \x20necessary\x20when\x20the\x20network\x20fabric\x20is\x20experiencing\
    \x20a\n\x20significant\x20error\x20rate.\x20\x20Without\x20it\x20we'll\
    \x20fail\x20a\x20step\x20on\x20an\x20network\x20error,\n\x20while\x20wit\
    h\x20it\x20we'll\x20be\x20able\x20to\x20complete\x20long\x20steps\x20(li\
    ke\x20complex\n\x20initializations)\x20in\x20the\x20face\x20of\x20some\
    \x20network\x20errors\x20during\x20RecvTensor.\n\n\r\n\x05\x04\x04\x02\
    \x03\x05\x12\x04\xdc\x02\x02\x06\n\r\n\x05\x04\x04\x02\x03\x01\x12\x04\
    \xdc\x02\x07\x19\n\r\n\x05\x04\x04\x02\x03\x03\x12\x04\xdc\x02\x1c\x1d\n\
    O\n\x04\x04\x04\x02\x04\x12\x04\xdf\x02\x02.\x1aA\x20Disables\x20TCP\x20\
    connection\x20sharing\x20when\x20opening\x20a\x20new\x20RPC\x20channel.\
    \n\n\r\n\x05\x04\x04\x02\x04\x05\x12\x04\xdf\x02\x02\x06\n\r\n\x05\x04\
    \x04\x02\x04\x01\x12\x04\xdf\x02\x07)\n\r\n\x05\x04\x04\x02\x04\x03\x12\
    \x04\xdf\x02,-\n\xad\x02\n\x02\x04\x05\x12\x06\xea\x02\0\xef\x02\x01\x1a\
    \x9e\x02\x20Metadata\x20about\x20the\x20session.\n\n\x20This\x20can\x20b\
    e\x20used\x20by\x20the\x20runtime\x20and\x20the\x20Ops\x20for\x20debuggi\
    ng,\x20monitoring,\x20etc.\n\n\x20The\x20(name,\x20version)\x20tuple\x20\
    is\x20expected\x20to\x20be\x20a\x20unique\x20identifier\x20for\n\x20sess\
    ions\x20within\x20the\x20same\x20process.\n\n\x20NOTE:\x20This\x20is\x20\
    currently\x20used\x20and\x20propagated\x20only\x20by\x20the\x20direct\
    \x20session.\n\n\x0b\n\x03\x04\x05\x01\x12\x04\xea\x02\x08\x17\n\x0c\n\
    \x04\x04\x05\x02\0\x12\x04\xeb\x02\x02\x12\n\r\n\x05\x04\x05\x02\0\x05\
    \x12\x04\xeb\x02\x02\x08\n\r\n\x05\x04\x05\x02\0\x01\x12\x04\xeb\x02\t\r\
    \n\r\n\x05\x04\x05\x02\0\x03\x12\x04\xeb\x02\x10\x11\nB\n\x04\x04\x05\
    \x02\x01\x12\x04\xee\x02\x02\x14\x1a4\x20The\x20version\x20is\x20optiona\
    l.\x20If\x20set,\x20needs\x20to\x20be\x20>=\x200.\n\n\r\n\x05\x04\x05\
    \x02\x01\x05\x12\x04\xee\x02\x02\x07\n\r\n\x05\x04\x05\x02\x01\x01\x12\
    \x04\xee\x02\x08\x0f\n\r\n\x05\x04\x05\x02\x01\x03\x12\x04\xee\x02\x12\
    \x13\ns\n\x02\x04\x06\x12\x06\xf3\x02\0\x84\x05\x01\x1ae\x20Session\x20c\
    onfiguration\x20parameters.\n\x20The\x20system\x20picks\x20appropriate\
    \x20values\x20for\x20fields\x20that\x20are\x20not\x20set.\n\n\x0b\n\x03\
    \x04\x06\x01\x12\x04\xf3\x02\x08\x13\n\xd5\x01\n\x04\x04\x06\x02\0\x12\
    \x04\xf8\x02\x02&\x1a\xc6\x01\x20Map\x20from\x20device\x20type\x20name\
    \x20(e.g.,\x20\"CPU\"\x20or\x20\"GPU\"\x20)\x20to\x20maximum\n\x20number\
    \x20of\x20devices\x20of\x20that\x20type\x20to\x20use.\x20\x20If\x20a\x20\
    particular\x20device\n\x20type\x20is\x20not\x20found\x20in\x20the\x20map\
    ,\x20the\x20system\x20picks\x20an\x20appropriate\n\x20number.\n\n\r\n\
    \x05\x04\x06\x02\0\x06\x12\x04\xf8\x02\x02\x14\n\r\n\x05\x04\x06\x02\0\
    \x01\x12\x04\xf8\x02\x15!\n\r\n\x05\x04\x06\x02\0\x03\x12\x04\xf8\x02$%\
    \n\xee\x05\n\x04\x04\x06\x02\x01\x12\x04\x88\x03\x02)\x1a\xdf\x05\x20The\
    \x20execution\x20of\x20an\x20individual\x20op\x20(for\x20some\x20op\x20t\
    ypes)\x20can\x20be\n\x20parallelized\x20on\x20a\x20pool\x20of\x20intra_o\
    p_parallelism_threads.\n\x200\x20means\x20the\x20system\x20picks\x20an\
    \x20appropriate\x20number.\n\n\x20If\x20you\x20create\x20an\x20ordinary\
    \x20session,\x20e.g.,\x20from\x20Python\x20or\x20C++,\n\x20then\x20there\
    \x20is\x20exactly\x20one\x20intra\x20op\x20thread\x20pool\x20per\x20proc\
    ess.\n\x20The\x20first\x20session\x20created\x20determines\x20the\x20num\
    ber\x20of\x20threads\x20in\x20this\x20pool.\n\x20All\x20subsequent\x20se\
    ssions\x20reuse/share\x20this\x20one\x20global\x20pool.\n\n\x20There\x20\
    are\x20notable\x20exceptions\x20to\x20the\x20default\x20behavior\x20desc\
    ribe\x20above:\n\x201.\x20There\x20is\x20an\x20environment\x20variable\
    \x20\x20for\x20overriding\x20this\x20thread\x20pool,\n\x20\x20\x20\x20na\
    med\x20TF_OVERRIDE_GLOBAL_THREADPOOL.\n\x202.\x20When\x20connecting\x20t\
    o\x20a\x20server,\x20such\x20as\x20a\x20remote\x20`tf.train.Server`\n\
    \x20\x20\x20\x20instance,\x20then\x20this\x20option\x20will\x20be\x20ign\
    ored\x20altogether.\n\n\r\n\x05\x04\x06\x02\x01\x05\x12\x04\x88\x03\x02\
    \x07\n\r\n\x05\x04\x06\x02\x01\x01\x12\x04\x88\x03\x08$\n\r\n\x05\x04\
    \x06\x02\x01\x03\x12\x04\x88\x03'(\n\xbd\x03\n\x04\x04\x06\x02\x02\x12\
    \x04\x93\x03\x02)\x1a\xae\x03\x20Nodes\x20that\x20perform\x20blocking\
    \x20operations\x20are\x20enqueued\x20on\x20a\x20pool\x20of\n\x20inter_op\
    _parallelism_threads\x20available\x20in\x20each\x20process.\n\n\x200\x20\
    means\x20the\x20system\x20picks\x20an\x20appropriate\x20number.\n\x20Neg\
    ative\x20means\x20all\x20operations\x20are\x20performed\x20in\x20caller'\
    s\x20thread.\n\n\x20Note\x20that\x20the\x20first\x20Session\x20created\
    \x20in\x20the\x20process\x20sets\x20the\n\x20number\x20of\x20threads\x20\
    for\x20all\x20future\x20sessions\x20unless\x20use_per_session_threads\
    \x20is\n\x20true\x20or\x20session_inter_op_thread_pool\x20is\x20configur\
    ed.\n\n\r\n\x05\x04\x06\x02\x02\x05\x12\x04\x93\x03\x02\x07\n\r\n\x05\
    \x04\x06\x02\x02\x01\x12\x04\x93\x03\x08$\n\r\n\x05\x04\x06\x02\x02\x03\
    \x12\x04\x93\x03'(\n\xd0\x03\n\x04\x04\x06\x02\x03\x12\x04\x9e\x03\x02#\
    \x1a\xc1\x03\x20If\x20true,\x20use\x20a\x20new\x20set\x20of\x20threads\
    \x20for\x20this\x20session\x20rather\x20than\x20the\x20global\n\x20pool\
    \x20of\x20threads.\x20Only\x20supported\x20by\x20direct\x20sessions.\n\n\
    \x20If\x20false,\x20use\x20the\x20global\x20threads\x20created\x20by\x20\
    the\x20first\x20session,\x20or\x20the\n\x20per-session\x20thread\x20pool\
    s\x20configured\x20by\x20session_inter_op_thread_pool.\n\n\x20This\x20op\
    tion\x20is\x20deprecated.\x20The\x20same\x20effect\x20can\x20be\x20achie\
    ved\x20by\x20setting\n\x20session_inter_op_thread_pool\x20to\x20have\x20\
    one\x20element,\x20whose\x20num_threads\x20equals\n\x20inter_op_parallel\
    ism_threads.\n\n\r\n\x05\x04\x06\x02\x03\x05\x12\x04\x9e\x03\x02\x06\n\r\
    \n\x05\x04\x06\x02\x03\x01\x12\x04\x9e\x03\x07\x1e\n\r\n\x05\x04\x06\x02\
    \x03\x03\x12\x04\x9e\x03!\"\n\x91\x08\n\x04\x04\x06\x02\x04\x12\x04\xb3\
    \x03\x02C\x1a\x82\x08\x20This\x20option\x20is\x20experimental\x20-\x20it\
    \x20may\x20be\x20replaced\x20with\x20a\x20different\x20mechanism\n\x20in\
    \x20the\x20future.\n\n\x20Configures\x20session\x20thread\x20pools.\x20I\
    f\x20this\x20is\x20configured,\x20then\x20RunOptions\x20for\n\x20a\x20Ru\
    n\x20call\x20can\x20select\x20the\x20thread\x20pool\x20to\x20use.\n\n\
    \x20The\x20intended\x20use\x20is\x20for\x20when\x20some\x20session\x20in\
    vocations\x20need\x20to\x20run\x20in\x20a\n\x20background\x20pool\x20lim\
    ited\x20to\x20a\x20small\x20number\x20of\x20threads:\n\x20-\x20For\x20ex\
    ample,\x20a\x20session\x20may\x20be\x20configured\x20to\x20have\x20one\
    \x20large\x20pool\x20(for\n\x20regular\x20compute)\x20and\x20one\x20smal\
    l\x20pool\x20(for\x20periodic,\x20low\x20priority\x20work);\n\x20using\
    \x20the\x20small\x20pool\x20is\x20currently\x20the\x20mechanism\x20for\
    \x20limiting\x20the\x20inter-op\n\x20parallelism\x20of\x20the\x20low\x20\
    priority\x20work.\x20\x20Note\x20that\x20it\x20does\x20not\x20limit\x20t\
    he\n\x20parallelism\x20of\x20work\x20spawned\x20by\x20a\x20single\x20op\
    \x20kernel\x20implementation.\n\x20-\x20Using\x20this\x20setting\x20is\
    \x20normally\x20not\x20needed\x20in\x20training,\x20but\x20may\x20help\
    \x20some\n\x20serving\x20use\x20cases.\n\x20-\x20It\x20is\x20also\x20gen\
    erally\x20recommended\x20to\x20set\x20the\x20global_name\x20field\x20of\
    \x20this\n\x20proto,\x20to\x20avoid\x20creating\x20multiple\x20large\x20\
    pools.\x20It\x20is\x20typically\x20better\x20to\n\x20run\x20the\x20non-l\
    ow-priority\x20work,\x20even\x20across\x20sessions,\x20in\x20a\x20single\
    \x20large\n\x20pool.\n\n\r\n\x05\x04\x06\x02\x04\x04\x12\x04\xb3\x03\x02\
    \n\n\r\n\x05\x04\x06\x02\x04\x06\x12\x04\xb3\x03\x0b\x20\n\r\n\x05\x04\
    \x06\x02\x04\x01\x12\x04\xb3\x03!=\n\r\n\x05\x04\x06\x02\x04\x03\x12\x04\
    \xb3\x03@B\n\xbd\x01\n\x04\x04\x06\x02\x05\x12\x04\xb8\x03\x02\x1d\x1a\
    \xae\x01\x20Assignment\x20of\x20Nodes\x20to\x20Devices\x20is\x20recomput\
    ed\x20every\x20placement_period\n\x20steps\x20until\x20the\x20system\x20\
    warms\x20up\x20(at\x20which\x20point\x20the\x20recomputation\n\x20typica\
    lly\x20slows\x20down\x20automatically).\n\n\r\n\x05\x04\x06\x02\x05\x05\
    \x12\x04\xb8\x03\x02\x07\n\r\n\x05\x04\x06\x02\x05\x01\x12\x04\xb8\x03\
    \x08\x18\n\r\n\x05\x04\x06\x02\x05\x03\x12\x04\xb8\x03\x1b\x1c\n\xc5\x01\
    \n\x04\x04\x06\x02\x06\x12\x04\xbd\x03\x02%\x1a\xb6\x01\x20When\x20any\
    \x20filters\x20are\x20present\x20sessions\x20will\x20ignore\x20all\x20de\
    vices\x20which\x20do\x20not\n\x20match\x20the\x20filters.\x20Each\x20fil\
    ter\x20can\x20be\x20partially\x20specified,\x20e.g.\x20\"/job:ps\"\n\x20\
    \"/job:worker/replica:3\",\x20etc.\n\n\r\n\x05\x04\x06\x02\x06\x04\x12\
    \x04\xbd\x03\x02\n\n\r\n\x05\x04\x06\x02\x06\x05\x12\x04\xbd\x03\x0b\x11\
    \n\r\n\x05\x04\x06\x02\x06\x01\x12\x04\xbd\x03\x12\x20\n\r\n\x05\x04\x06\
    \x02\x06\x03\x12\x04\xbd\x03#$\n/\n\x04\x04\x06\x02\x07\x12\x04\xc0\x03\
    \x02\x1d\x1a!\x20Options\x20that\x20apply\x20to\x20all\x20GPUs.\n\n\r\n\
    \x05\x04\x06\x02\x07\x06\x12\x04\xc0\x03\x02\x0c\n\r\n\x05\x04\x06\x02\
    \x07\x01\x12\x04\xc0\x03\r\x18\n\r\n\x05\x04\x06\x02\x07\x03\x12\x04\xc0\
    \x03\x1b\x1c\n\x9a\x02\n\x04\x04\x06\x02\x08\x12\x04\xc9\x03\x02\x20\x1a\
    \x8b\x02\x20Whether\x20soft\x20placement\x20is\x20allowed.\x20If\x20allo\
    w_soft_placement\x20is\x20true,\n\x20an\x20op\x20will\x20be\x20placed\
    \x20on\x20CPU\x20if\n\x20\x20\x201.\x20there's\x20no\x20GPU\x20implement\
    ation\x20for\x20the\x20OP\n\x20or\n\x20\x20\x202.\x20no\x20GPU\x20device\
    s\x20are\x20known\x20or\x20registered\n\x20or\n\x20\x20\x203.\x20need\
    \x20to\x20co-locate\x20with\x20reftype\x20input(s)\x20which\x20are\x20fr\
    om\x20CPU.\n\n\r\n\x05\x04\x06\x02\x08\x05\x12\x04\xc9\x03\x02\x06\n\r\n\
    \x05\x04\x06\x02\x08\x01\x12\x04\xc9\x03\x07\x1b\n\r\n\x05\x04\x06\x02\
    \x08\x03\x12\x04\xc9\x03\x1e\x1f\n;\n\x04\x04\x06\x02\t\x12\x04\xcc\x03\
    \x02\x20\x1a-\x20Whether\x20device\x20placements\x20should\x20be\x20logg\
    ed.\n\n\r\n\x05\x04\x06\x02\t\x05\x12\x04\xcc\x03\x02\x06\n\r\n\x05\x04\
    \x06\x02\t\x01\x12\x04\xcc\x03\x07\x1b\n\r\n\x05\x04\x06\x02\t\x03\x12\
    \x04\xcc\x03\x1e\x1f\n1\n\x04\x04\x06\x02\n\x12\x04\xcf\x03\x02\"\x1a#\
    \x20Options\x20that\x20apply\x20to\x20all\x20graphs.\n\n\r\n\x05\x04\x06\
    \x02\n\x06\x12\x04\xcf\x03\x02\x0e\n\r\n\x05\x04\x06\x02\n\x01\x12\x04\
    \xcf\x03\x0f\x1c\n\r\n\x05\x04\x06\x02\n\x03\x12\x04\xcf\x03\x1f!\n\xce\
    \x01\n\x04\x04\x06\x02\x0b\x12\x04\xd4\x03\x02%\x1a\xbf\x01\x20Global\
    \x20timeout\x20for\x20all\x20blocking\x20operations\x20in\x20this\x20ses\
    sion.\x20\x20If\x20non-zero,\n\x20and\x20not\x20overridden\x20on\x20a\
    \x20per-operation\x20basis,\x20this\x20value\x20will\x20be\x20used\x20as\
    \x20the\n\x20deadline\x20for\x20all\x20blocking\x20operations.\n\n\r\n\
    \x05\x04\x06\x02\x0b\x05\x12\x04\xd4\x03\x02\x07\n\r\n\x05\x04\x06\x02\
    \x0b\x01\x12\x04\xd4\x03\x08\x1f\n\r\n\x05\x04\x06\x02\x0b\x03\x12\x04\
    \xd4\x03\"$\nR\n\x04\x04\x06\x02\x0c\x12\x04\xd7\x03\x02\x1e\x1aD\x20Opt\
    ions\x20that\x20apply\x20when\x20this\x20session\x20uses\x20the\x20distr\
    ibuted\x20runtime.\n\n\r\n\x05\x04\x06\x02\x0c\x06\x12\x04\xd7\x03\x02\
    \x0c\n\r\n\x05\x04\x06\x02\x0c\x01\x12\x04\xd7\x03\r\x18\n\r\n\x05\x04\
    \x06\x02\x0c\x03\x12\x04\xd7\x03\x1b\x1d\nD\n\x04\x04\x06\x02\r\x12\x04\
    \xda\x03\x02\x1e\x1a6\x20Optional\x20list\x20of\x20all\x20workers\x20to\
    \x20use\x20in\x20this\x20session.\n\n\r\n\x05\x04\x06\x02\r\x06\x12\x04\
    \xda\x03\x02\x0c\n\r\n\x05\x04\x06\x02\r\x01\x12\x04\xda\x03\r\x18\n\r\n\
    \x05\x04\x06\x02\r\x03\x12\x04\xda\x03\x1b\x1d\n\xe1\x01\n\x04\x04\x06\
    \x02\x0e\x12\x04\xdf\x03\x02\"\x1a\xd2\x01\x20If\x20true,\x20any\x20reso\
    urces\x20such\x20as\x20Variables\x20used\x20in\x20the\x20session\x20will\
    \x20not\x20be\n\x20shared\x20with\x20other\x20sessions.\x20However,\x20w\
    hen\x20clusterspec\x20propagation\x20is\n\x20enabled,\x20this\x20field\
    \x20is\x20ignored\x20and\x20sessions\x20are\x20always\x20isolated.\n\n\r\
    \n\x05\x04\x06\x02\x0e\x05\x12\x04\xdf\x03\x02\x06\n\r\n\x05\x04\x06\x02\
    \x0e\x01\x12\x04\xdf\x03\x07\x1c\n\r\n\x05\x04\x06\x02\x0e\x03\x12\x04\
    \xdf\x03\x1f!\n\xca\x01\n\x04\x04\x06\x02\x0f\x12\x04\xe5\x03\x02-\x1a\
    ...
    \n\r\n\x05\x04\x06\x02\x0f\x05\x12\x04\xe5\x03\x02\x06\n\r\n\x05\x04\x06\
    \x02\x0f\x01\x12\x04\xe5\x03\x07'\n\r\n\x05\x04\x06\x02\x0f\x03\x12\x04\
    \xe5\x03*,\n\xab\x01\n\x04\x04\x06\x03\x01\x12\x06\xea\x03\x02\xff\x04\
    ...
    ompat.\n\n\r\n\x05\x04\x06\x03\x01\x01\x12\x04\xea\x03\n\x16\n1\n\x06\
    \x04\x06\x03\x01\x02\0\x12\x04\xec\x03\x04'\x1a!\x20Task\x20name\x20for\
    \x20group\x20resolution.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\0\x05\x12\x04\
    \xec\x03\x04\n\n\x0f\n\x07\x04\x06\x03\x01\x02\0\x01\x12\x04\xec\x03\x0b\
    \"\n\x0f\n\x07\x04\x06\x03\x01\x02\0\x03\x12\x04\xec\x03%&\n\xd6\x01\n\
    \x05\x04\x06\x03\x01\t\x12\x04\xf2\x03\x04\x0f\x1a\xc6\x01\x20We\x20remo\
    ved\x20the\x20flag\x20client_handles_error_formatting.\x20Marking\x20the\
    \x20tag\n\x20number\x20as\x20reserved.\n\x20TODO(shikharagarwal):\x20Sho\
    uld\x20we\x20just\x20remove\x20this\x20tag\x20so\x20that\x20it\x20can\
    \x20be\n\x20used\x20in\x20future\x20for\x20other\x20purpose?\n\n\x0e\n\
    \x06\x04\x06\x03\x01\t\0\x12\x04\xf2\x03\r\x0e\n\x0f\n\x07\x04\x06\x03\
    \x01\t\0\x01\x12\x04\xf2\x03\r\x0e\n\x0f\n\x07\x04\x06\x03\x01\t\0\x02\
    \x12\x04\xf2\x03\r\x0e\nq\n\x06\x04\x06\x03\x01\x02\x01\x12\x04\xf6\x03\
    \x04\x1d\x1aa\x20Which\x20executor\x20to\x20use,\x20the\x20default\x20ex\
    ecutor\x20will\x20be\x20used\n\x20if\x20it\x20is\x20an\x20empty\x20strin\
    g\x20or\x20\"DEFAULT\"\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x01\x05\x12\x04\
    \xf6\x03\x04\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x01\x01\x12\x04\xf6\x03\
    \x0b\x18\n\x0f\n\x07\x04\x06\x03\x01\x02\x01\x03\x12\x04\xf6\x03\x1b\x1c\
    \n\xcc\x01\n\x06\x04\x06\x03\x01\x02\x02\x12\x04\xfb\x03\x04!\x1a\xbb\
    \x01\x20Guidance\x20to\x20formatting\x20of\x20large\x20RecvBuf\x20fields\
    \x20for\x20transfer.\n\x20Any\x20positive\x20value\x20sets\x20the\x20max\
    \x20chunk\x20size.\x20\x200\x20defaults\x20to\x204096.\n\x20Any\x20negat\
    ive\x20value\x20indicates\x20no\x20max,\x20i.e.\x20one\x20chunk\x20only.\
    \n\n\x0f\n\x07\x04\x06\x03\x01\x02\x02\x05\x12\x04\xfb\x03\x04\t\n\x0f\n\
    \x07\x04\x06\x03\x01\x02\x02\x01\x12\x04\xfb\x03\n\x1c\n\x0f\n\x07\x04\
    \x06\x03\x01\x02\x02\x03\x12\x04\xfb\x03\x1f\x20\n\xdd\x01\n\x06\x04\x06\
    \x03\x01\x02\x03\x12\x04\x80\x04\x04\x1f\x1a\xcc\x01\x20If\x20true,\x20a\
    nd\x20supported\x20by\x20the\x20platform,\x20the\x20runtime\x20will\x20a\
    ttempt\x20to\n\x20use\x20NUMA\x20affinity\x20where\x20applicable.\x20\
    \x20One\x20consequence\x20will\x20be\x20the\n\x20existence\x20of\x20as\
    \x20many\x20CPU\x20devices\x20as\x20there\x20are\x20available\x20NUMA\
    \x20nodes.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x03\x05\x12\x04\x80\x04\x04\
    \x08\n\x0f\n\x07\x04\x06\x03\x01\x02\x03\x01\x12\x04\x80\x04\t\x1a\n\x0f\
    \n\x07\x04\x06\x03\x01\x02\x03\x03\x12\x04\x80\x04\x1d\x1e\n\x8c\x01\n\
    \x06\x04\x06\x03\x01\x02\x04\x12\x04\x84\x04\x04;\x1a|\x20If\x20true,\
    \x20make\x20collective\x20op\x20execution\x20order\x20sequential\x20and\
    \x20deterministic\n\x20for\x20potentially\x20concurrent\x20collective\
    \x20instances.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x04\x05\x12\x04\x84\x04\
    \x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\x04\x01\x12\x04\x84\x04\t6\n\
    \x0f\n\x07\x04\x06\x03\x01\x02\x04\x03\x12\x04\x84\x049:\n]\n\x06\x04\
    \x06\x03\x01\x02\x05\x12\x04\x88\x04\x04\x1d\x1aM\x20If\x20true,\x20use\
    \x20NCCL\x20for\x20CollectiveOps.\x20\x20This\x20feature\x20is\x20highly\
    \n\x20experimental.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x05\x05\x12\x04\
    \x88\x04\x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\x05\x01\x12\x04\x88\x04\
    \t\x18\n\x0f\n\x07\x04\x06\x03\x01\x02\x05\x03\x12\x04\x88\x04\x1b\x1c\n\
    \xda\x07\n\x06\x04\x06\x03\x01\x02\x06\x12\x04\x9e\x04\x04<\x1a\xc9\x07\
    \x20In\x20the\x20following,\x20session\x20state\x20means\x20the\x20value\
    \x20of\x20a\x20variable,\x20elements\n\x20in\x20a\x20hash\x20table,\x20o\
    r\x20any\x20other\x20resource,\x20accessible\x20by\x20worker\x20sessions\
    \n\x20held\x20by\x20a\x20TF\x20server.\n\n\x20When\x20ClusterSpec\x20pro\
    pagation\x20is\x20enabled,\x20the\x20value\x20of\n\x20isolate_session_st\
    ate\x20is\x20ignored\x20when\x20deciding\x20whether\x20to\x20share\x20se\
    ssion\n\x20states\x20in\x20a\x20TF\x20server\x20(for\x20backwards\x20com\
    patibility\x20reasons).\n\x20-\x20If\x20share_session_state_in_clustersp\
    ec_propagation\x20is\x20true,\x20the\x20session\n\x20states\x20are\x20sh\
    ared.\n\x20-\x20If\x20share_session_state_in_clusterspec_propagation\x20\
    is\x20false,\x20session\n\x20states\x20are\x20isolated.\n\n\x20When\x20c\
    lusterspec\x20propagation\x20is\x20not\x20used,\x20the\x20value\x20of\n\
    \x20share_session_state_in_clusterspec_propagation\x20is\x20ignored\x20w\
    hen\x20deciding\n\x20whether\x20to\x20share\x20session\x20states\x20in\
    \x20a\x20TF\x20server.\n\x20-\x20If\x20isolate_session_state\x20is\x20tr\
    ue,\x20session\x20states\x20are\x20isolated.\n\x20-\x20If\x20isolate_ses\
    sion_state\x20is\x20false,\x20session\x20states\x20are\x20shared.\n\n\
    \x20TODO(b/129330037):\x20Add\x20a\x20single\x20API\x20that\x20consisten\
    tly\x20treats\n\x20isolate_session_state\x20and\x20ClusterSpec\x20propag\
    ation.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x06\x05\x12\x04\x9e\x04\x04\x08\
    \n\x0f\n\x07\x04\x06\x03\x01\x02\x06\x01\x12\x04\x9e\x04\t7\n\x0f\n\x07\
    \x04\x06\x03\x01\x02\x06\x03\x12\x04\x9e\x04:;\n\xf2\x01\n\x06\x04\x06\
    \x03\x01\x02\x07\x12\x04\xa4\x04\x04%\x1a\xe1\x01\x20If\x20using\x20a\
    \x20direct\x20session,\x20disable\x20spinning\x20while\x20waiting\x20for\
    \x20work\x20in\n\x20the\x20thread\x20pool.\x20This\x20may\x20result\x20i\
    n\x20higher\x20latency\x20for\x20completing\x20ops,\n\x20but\x20in\x20th\
    e\x20case\x20where\x20there\x20is\x20a\x20lot\x20of\x20spinning\x20may\
    \x20result\x20in\x20lower\n\x20CPU\x20usage.\n\n\x0f\n\x07\x04\x06\x03\
    \x01\x02\x07\x05\x12\x04\xa4\x04\x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\
    \x07\x01\x12\x04\xa4\x04\t\x20\n\x0f\n\x07\x04\x06\x03\x01\x02\x07\x03\
    \x12\x04\xa4\x04#$\n\x80\x01\n\x06\x04\x06\x03\x01\x02\x08\x12\x04\xa8\
    \x04\x04/\x1ap\x20This\x20was\x20promoted\x20to\x20a\x20non-experimental\
    \x20API.\x20Please\x20use\n\x20ConfigProto.share_cluster_devices_in_sess\
    ion\x20instead.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x08\x05\x12\x04\xa8\
    \x04\x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\x08\x01\x12\x04\xa8\x04\t)\
    \n\x0f\n\x07\x04\x06\x03\x01\x02\x08\x03\x12\x04\xa8\x04,.\n\xcf\x01\n\
    \x06\x04\x06\x03\x01\x02\t\x12\x04\xb0\x04\x04*\x1a\xbe\x01\x20Metadata\
    \x20about\x20the\x20session.\n\n\x20If\x20set,\x20this\x20can\x20be\x20u\
    sed\x20by\x20the\x20runtime\x20and\x20the\x20Ops\x20for\x20debugging,\n\
    \x20monitoring,\x20etc.\n\n\x20NOTE:\x20This\x20is\x20currently\x20used\
    \x20and\x20propagated\x20only\x20by\x20the\x20direct\x20session.\n\n\x0f\
    \n\x07\x04\x06\x03\x01\x02\t\x06\x12\x04\xb0\x04\x04\x13\n\x0f\n\x07\x04\
    \x06\x03\x01\x02\t\x01\x12\x04\xb0\x04\x14$\n\x0f\n\x07\x04\x06\x03\x01\
    \x02\t\x03\x12\x04\xb0\x04')\n\x98\x02\n\x06\x04\x06\x03\x01\x02\n\x12\
    \x04\xb8\x04\x04(\x1a\x87\x02\x20If\x20true,\x20the\x20session\x20may\
    \x20treat\x20the\x20graph\x20as\x20being\x20static\x20for\x20optimizatio\
    n\n\x20purposes.\n\n\x20If\x20this\x20option\x20is\x20set\x20to\x20true\
    \x20when\x20a\x20session\x20is\x20created,\x20the\x20full\n\x20GraphDef\
    \x20must\x20be\x20passed\x20in\x20a\x20single\x20call\x20to\x20Session::\
    Create(),\x20and\n\x20Session::Extend()\x20may\x20not\x20be\x20supported\
    .\n\n\x0f\n\x07\x04\x06\x03\x01\x02\n\x05\x12\x04\xb8\x04\x04\x08\n\x0f\
    \n\x07\x04\x06\x03\x01\x02\n\x01\x12\x04\xb8\x04\t\"\n\x0f\n\x07\x04\x06\
    \x03\x01\x02\n\x03\x12\x04\xb8\x04%'\n\xe5\x05\n\x06\x04\x06\x03\x01\x02\
    \x0b\x12\x04\xc8\x04\x04!\x1a\xd4\x05\x20This\x20field\x20will\x20eventu\
    ally\x20be\x20deprecated\x20and\x20replaced\x20by\n\x20mlir_bridge_rollo\
    ...
    \x07\x04\x06\x03\x01\x02\x0b\x05\x12\x04\xc8\x04\x04\x08\n\x0f\n\x07\x04\
    \x06\x03\x01\x02\x0b\x01\x12\x04\xc8\x04\t\x1b\n\x0f\n\x07\x04\x06\x03\
    \x01\x02\x0b\x03\x12\x04\xc8\x04\x1e\x20\nP\n\x06\x04\x06\x03\x01\x04\0\
    \x12\x06\xcb\x04\x04\xdf\x04\x05\x1a>\x20An\x20enum\x20that\x20describes\
    \x20the\x20state\x20of\x20the\x20MLIR\x20bridge\x20rollout.\n\n\x0f\n\
    \x07\x04\x06\x03\x01\x04\0\x01\x12\x04\xcb\x04\t\x1a\nx\n\x08\x04\x06\
    \x03\x01\x04\0\x02\0\x12\x04\xce\x04\x06*\x1af\x20If\x20this\x20field\
    \x20is\x20left\x20unspecified,\x20the\x20MLIR\x20bridge\x20may\x20be\x20\
    selectively\n\x20enabled\x20on\x20a\x20per\x20graph\x20basis.\n\n\x11\n\
    \t\x04\x06\x03\x01\x04\0\x02\0\x01\x12\x04\xce\x04\x06%\n\x11\n\t\x04\
    \x06\x03\x01\x04\0\x02\0\x02\x12\x04\xce\x04()\nW\n\x08\x04\x06\x03\x01\
    \x04\0\x02\x01\x12\x04\xd0\x04\x06&\x1aE\x20Enabling\x20the\x20MLIR\x20b\
    ridge\x20enables\x20it\x20for\x20all\x20graphs\x20in\x20this\x20session.\
    \n\n\x11\n\t\x04\x06\x03\x01\x04\0\x02\x01\x01\x12\x04\xd0\x04\x06!\n\
    \x11\n\t\x04\x06\x03\x01\x04\0\x02\x01\x02\x12\x04\xd0\x04$%\nY\n\x08\
    \x04\x06\x03\x01\x04\0\x02\x02\x12\x04\xd2\x04\x06'\x1aG\x20Disabling\
    \x20the\x20MLIR\x20bridge\x20disables\x20it\x20for\x20all\x20graphs\x20i\
    n\x20this\x20session.\n\n\x11\n\t\x04\x06\x03\x01\x04\0\x02\x02\x01\x12\
    \x04\xd2\x04\x06\"\n\x11\n\t\x04\x06\x03\x01\x04\0\x02\x02\x02\x12\x04\
    \xd2\x04%&\n\xee\x01\n\x08\x04\x06\x03\x01\x04\0\x02\x03\x12\x04\xd7\x04\
    \x060\x1a\xdb\x01\x20Enable\x20the\x20MLIR\x20bridge\x20on\x20a\x20per\
    \x20graph\x20basis\x20based\x20on\x20an\x20analysis\x20of\n\x20the\x20fe\
    atures\x20used\x20in\x20the\x20graph.\x20If\x20the\x20features\x20used\
    \x20by\x20the\x20graph\x20are\n\x20supported\x20by\x20the\x20MLIR\x20bri\
    dge,\x20the\x20MLIR\x20bridge\x20will\x20be\x20used\x20to\x20run\x20the\
    \n\x20graph.\n\n\x11\n\t\x04\x06\x03\x01\x04\0\x02\x03\x01\x12\x04\xd7\
    \x04\x06+\n\x11\n\t\x04\x06\x03\x01\x04\0\x02\x03\x02\x12\x04\xd7\x04./\
    \n\xee\x02\n\x08\x04\x06\x03\x01\x04\0\x02\x04\x12\x04\xde\x04\x069\x1a\
    \xdb\x02\x20Enable\x20the\x20MLIR\x20bridge\x20in\x20a\x20fallback\x20mo\
    de\x20on\x20a\x20per\x20graph\x20basis\x20based\n\x20on\x20an\x20analysi\
    s\x20of\x20the\x20features\x20used\x20in\x20the\x20graph.\n\x20Running\
    \x20the\x20MLIR\x20bridge\x20in\x20the\x20fallback\x20mode\x20means\x20t\
    hat\x20it\x20is\n\x20executed\x20and\x20it\x20commits\x20all\x20the\x20c\
    hanges\x20to\x20the\x20TF\x20graph\x20in\x20case\n\x20of\x20success.\x20\
    And\x20it\x20does\x20not\x20in\x20case\x20of\x20failures\x20and\x20let\
    \x20the\x20old\x20bridge\n\x20to\x20process\x20the\x20TF\x20graph.\n\n\
    \x11\n\t\x04\x06\x03\x01\x04\0\x02\x04\x01\x12\x04\xde\x04\x064\n\x11\n\
    \t\x04\x06\x03\x01\x04\0\x02\x04\x02\x12\x04\xde\x0478\n\x94\x01\n\x06\
    \x04\x06\x03\x01\x02\x0c\x12\x04\xe4\x04\x04/\x1a\x83\x01\x20This\x20fie\
    ld\x20is\x20underdevelopment,\x20for\x20now\x20use\x20enable_mlir_bridge\
    \n\x20(b/166038521).\n\n\x20Whether\x20to\x20enable\x20the\x20MLIR-based\
    \x20TF->XLA\x20bridge.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x0c\x06\x12\x04\
    \xe4\x04\x04\x15\n\x0f\n\x07\x04\x06\x03\x01\x02\x0c\x01\x12\x04\xe4\x04\
    \x16)\n\x0f\n\x07\x04\x06\x03\x01\x02\x0c\x03\x12\x04\xe4\x04,.\n\x98\
    \x02\n\x06\x04\x06\x03\x01\x02\r\x12\x04\xeb\x04\x04-\x1a\x87\x02\x20Whe\
    ...
    n\x20Grappler.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\r\x05\x12\x04\xeb\x04\
    \x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\r\x01\x12\x04\xeb\x04\t'\n\x0f\
    \n\x07\x04\x06\x03\x01\x02\r\x03\x12\x04\xeb\x04*,\n\xe8\x01\n\x06\x04\
    \x06\x03\x01\x02\x0e\x12\x04\xf2\x04\x04.\x1a\xd7\x01\x20If\x20true,\x20\
    ...
    not\x20be\x20set.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x0e\x05\x12\x04\xf2\
    \x04\x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\x0e\x01\x12\x04\xf2\x04\t(\
    \n\x0f\n\x07\x04\x06\x03\x01\x02\x0e\x03\x12\x04\xf2\x04+-\n\x8d\x02\n\
    \x06\x04\x06\x03\x01\x02\x0f\x12\x04\xf9\x04\x04+\x1a\xfc\x01\x20Minimum\
    ...
    .\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x0f\x05\x12\x04\xf9\x04\x04\t\n\x0f\
    \n\x07\x04\x06\x03\x01\x02\x0f\x01\x12\x04\xf9\x04\n%\n\x0f\n\x07\x04\
    \x06\x03\x01\x02\x0f\x03\x12\x04\xf9\x04(*\n6\n\x06\x04\x06\x03\x01\x02\
    \x10\x12\x04\xfc\x04\x04\x17\x1a&\x20Whether\x20runtime\x20execution\x20\
    uses\x20TFRT.\n\n\x0f\n\x07\x04\x06\x03\x01\x02\x10\x05\x12\x04\xfc\x04\
    \x04\x08\n\x0f\n\x07\x04\x06\x03\x01\x02\x10\x01\x12\x04\xfc\x04\t\x11\n\
    \x0f\n\x07\x04\x06\x03\x01\x02\x10\x03\x12\x04\xfc\x04\x14\x16\n\x0c\n\
    \x04\x04\x06\x02\x10\x12\x04\x81\x05\x02!\n\r\n\x05\x04\x06\x02\x10\x06\
    \x12\x04\x81\x05\x02\x0e\n\r\n\x05\x04\x06\x02\x10\x01\x12\x04\x81\x05\
    \x0f\x1b\n\r\n\x05\x04\x06\x02\x10\x03\x12\x04\x81\x05\x1e\x20\n0\n\x02\
    \x04\x07\x12\x06\x87\x05\0\xc5\x05\x01\x1a\"\x20Options\x20for\x20a\x20s\
    ingle\x20Run()\x20call.\n\n\x0b\n\x03\x04\x07\x01\x12\x04\x87\x05\x08\
    \x12\n\x84\x01\n\x04\x04\x07\x04\0\x12\x06\x8a\x05\x02\x8f\x05\x03\x1at\
    \x20TODO(pbar)\x20Turn\x20this\x20into\x20a\x20TraceOptions\x20proto\x20\
    which\x20allows\n\x20tracing\x20to\x20be\x20controlled\x20in\x20a\x20mor\
    e\x20orthogonal\x20manner?\n\n\r\n\x05\x04\x07\x04\0\x01\x12\x04\x8a\x05\
    \x07\x11\n\x0e\n\x06\x04\x07\x04\0\x02\0\x12\x04\x8b\x05\x04\x11\n\x0f\n\
    \x07\x04\x07\x04\0\x02\0\x01\x12\x04\x8b\x05\x04\x0c\n\x0f\n\x07\x04\x07\
    \x04\0\x02\0\x02\x12\x04\x8b\x05\x0f\x10\n\x0e\n\x06\x04\x07\x04\0\x02\
    \x01\x12\x04\x8c\x05\x04\x17\n\x0f\n\x07\x04\x07\x04\0\x02\x01\x01\x12\
    \x04\x8c\x05\x04\x12\n\x0f\n\x07\x04\x07\x04\0\x02\x01\x02\x12\x04\x8c\
    \x05\x15\x16\n\x0e\n\x06\x04\x07\x04\0\x02\x02\x12\x04\x8d\x05\x04\x17\n\
    \x0f\n\x07\x04\x07\x04\0\x02\x02\x01\x12\x04\x8d\x05\x04\x12\n\x0f\n\x07\
    \x04\x07\x04\0\x02\x02\x02\x12\x04\x8d\x05\x15\x16\n\x0e\n\x06\x04\x07\
    \x04\0\x02\x03\x12\x04\x8e\x05\x04\x13\n\x0f\n\x07\x04\x07\x04\0\x02\x03\
    \x01\x12\x04\x8e\x05\x04\x0e\n\x0f\n\x07\x04\x07\x04\0\x02\x03\x02\x12\
    \x04\x8e\x05\x11\x12\n\x0c\n\x04\x04\x07\x02\0\x12\x04\x90\x05\x02\x1d\n\
    \r\n\x05\x04\x07\x02\0\x06\x12\x04\x90\x05\x02\x0c\n\r\n\x05\x04\x07\x02\
    \0\x01\x12\x04\x90\x05\r\x18\n\r\n\x05\x04\x07\x02\0\x03\x12\x04\x90\x05\
    \x1b\x1c\nG\n\x04\x04\x07\x02\x01\x12\x04\x93\x05\x02\x1a\x1a9\x20Time\
    \x20to\x20wait\x20for\x20operation\x20to\x20complete\x20in\x20millisecon\
    ds.\n\n\r\n\x05\x04\x07\x02\x01\x05\x12\x04\x93\x05\x02\x07\n\r\n\x05\
    \x04\x07\x02\x01\x01\x12\x04\x93\x05\x08\x15\n\r\n\x05\x04\x07\x02\x01\
    \x03\x12\x04\x93\x05\x18\x19\n\x9d\x03\n\x04\x04\x07\x02\x02\x12\x04\x9b\
    \x05\x02!\x1a\x8e\x03\x20The\x20thread\x20pool\x20to\x20use,\x20if\x20se\
    ssion_inter_op_thread_pool\x20is\x20configured.\n\x20To\x20use\x20the\
    \x20caller\x20thread\x20set\x20this\x20to\x20-1\x20-\x20this\x20uses\x20\
    the\x20caller\x20thread\n\x20to\x20execute\x20Session::Run()\x20and\x20t\
    hus\x20avoids\x20a\x20context\x20switch.\x20Using\x20the\n\x20caller\x20\
    thread\x20to\x20execute\x20Session::Run()\x20should\x20be\x20done\x20ONL\
    Y\x20for\x20simple\n\x20graphs,\x20where\x20the\x20overhead\x20of\x20an\
    \x20additional\x20context\x20switch\x20is\n\x20comparable\x20with\x20the\
    \x20overhead\x20of\x20Session::Run().\n\n\r\n\x05\x04\x07\x02\x02\x05\
    \x12\x04\x9b\x05\x02\x07\n\r\n\x05\x04\x07\x02\x02\x01\x12\x04\x9b\x05\
    \x08\x1c\n\r\n\x05\x04\x07\x02\x02\x03\x12\x04\x9b\x05\x1f\x20\np\n\x04\
    \x04\x07\x02\x03\x12\x04\x9f\x05\x02#\x1ab\x20Whether\x20the\x20partitio\
    n\x20graph(s)\x20executed\x20by\x20the\x20executor(s)\x20should\x20be\n\
    \x20outputted\x20via\x20RunMetadata.\n\n\r\n\x05\x04\x07\x02\x03\x05\x12\
    \x04\x9f\x05\x02\x06\n\r\n\x05\x04\x07\x02\x03\x01\x12\x04\x9f\x05\x07\
    \x1e\n\r\n\x05\x04\x07\x02\x03\x03\x12\x04\x9f\x05!\"\nT\n\x04\x04\x07\
    \x02\x04\x12\x04\xa2\x05\x02!\x1aF\x20EXPERIMENTAL.\x20\x20Options\x20us\
    ed\x20to\x20initialize\x20DebuggerState,\x20if\x20enabled.\n\n\r\n\x05\
    \x04\x07\x02\x04\x06\x12\x04\xa2\x05\x02\x0e\n\r\n\x05\x04\x07\x02\x04\
    \x01\x12\x04\xa2\x05\x0f\x1c\n\r\n\x05\x04\x07\x02\x04\x03\x12\x04\xa2\
    \x05\x1f\x20\n\xe7\x01\n\x04\x04\x07\x02\x05\x12\x04\xa9\x05\x02.\x1a\
    \xd8\x01\x20When\x20enabled,\x20causes\x20tensor\x20allocation\x20inform\
    ation\x20to\x20be\x20included\x20in\n\x20the\x20error\x20message\x20when\
    \x20the\x20Run()\x20call\x20fails\x20because\x20the\x20allocator\x20ran\
    \n\x20out\x20of\x20memory\x20(OOM).\n\n\x20Enabling\x20this\x20option\
    \x20can\x20slow\x20down\x20the\x20Run()\x20call.\n\n\r\n\x05\x04\x07\x02\
    \x05\x05\x12\x04\xa9\x05\x02\x06\n\r\n\x05\x04\x07\x02\x05\x01\x12\x04\
    \xa9\x05\x07)\n\r\n\x05\x04\x07\x02\x05\x03\x12\x04\xa9\x05,-\n\xab\x01\
    \n\x04\x04\x07\x03\0\x12\x06\xae\x05\x02\xc0\x05\x03\x1a\x9a\x01\x20Ever\
    ...
    \x07\x03\0\x01\x12\x04\xae\x05\n\x16\n\xec\x01\n\x06\x04\x07\x03\0\x02\0\
    \x12\x04\xb3\x05\x04#\x1a\xdb\x01\x20If\x20non-zero,\x20declares\x20that\
    \x20this\x20graph\x20is\x20going\x20to\x20use\x20collective\n\x20ops\x20\
    and\x20must\x20synchronize\x20step_ids\x20with\x20any\x20other\x20graph\
    \x20with\x20this\n\x20same\x20group_key\x20value\x20(in\x20a\x20distribu\
    ted\x20computation\x20where\x20tasks\n\x20run\x20disjoint\x20graphs).\n\
    \n\x0f\n\x07\x04\x07\x03\0\x02\0\x05\x12\x04\xb3\x05\x04\t\n\x0f\n\x07\
    \x04\x07\x03\0\x02\0\x01\x12\x04\xb3\x05\n\x1e\n\x0f\n\x07\x04\x07\x03\0\
    \x02\0\x03\x12\x04\xb3\x05!\"\n\xf2\x01\n\x06\x04\x07\x03\0\x02\x01\x12\
    \x04\xb8\x05\x04\"\x1a\xe1\x01\x20If\x20true,\x20then\x20operations\x20(\
    using\x20the\x20inter-op\x20pool)\x20across\x20all\n\x20session::run()\
    \x20calls\x20will\x20be\x20centrally\x20scheduled,\x20optimizing\x20for\
    \x20(median\n\x20and\x20tail)\x20latency.\n\x20Consider\x20using\x20this\
    \x20option\x20for\x20CPU-bound\x20workloads\x20like\x20inference.\n\n\
    \x0f\n\x07\x04\x07\x03\0\x02\x01\x05\x12\x04\xb8\x05\x04\x08\n\x0f\n\x07\
    \x04\x07\x03\0\x02\x01\x01\x12\x04\xb8\x05\t\x1d\n\x0f\n\x07\x04\x07\x03\
    \0\x02\x01\x03\x12\x04\xb8\x05\x20!\n8\n\x06\x04\x07\x03\0\x03\0\x12\x06\
    \xba\x05\x04\xbe\x05\x05\x1a&\x20Options\x20for\x20run\x20handler\x20thr\
    ead\x20pool.\n\n\x0f\n\x07\x04\x07\x03\0\x03\0\x01\x12\x04\xba\x05\x0c!\
    \n\xa3\x01\n\x08\x04\x07\x03\0\x03\0\x02\0\x12\x04\xbd\x05\x06\x19\x1a\
    \x90\x01\x20Priority\x20of\x20the\x20request.\x20The\x20run\x20handler\
    \x20thread\x20pool\x20will\x20schedule\x20ops\n\x20based\x20on\x20the\
    \x20priority\x20number.\x20The\x20larger\x20number\x20means\x20higher\
    \x20priority.\n\n\x11\n\t\x04\x07\x03\0\x03\0\x02\0\x05\x12\x04\xbd\x05\
    \x06\x0b\n\x11\n\t\x04\x07\x03\0\x03\0\x02\0\x01\x12\x04\xbd\x05\x0c\x14\
    \n\x11\n\t\x04\x07\x03\0\x03\0\x02\0\x03\x12\x04\xbd\x05\x17\x18\n\x0e\n\
    \x06\x04\x07\x03\0\x02\x02\x12\x04\xbf\x05\x047\n\x0f\n\x07\x04\x07\x03\
    \0\x02\x02\x06\x12\x04\xbf\x05\x04\x19\n\x0f\n\x07\x04\x07\x03\0\x02\x02\
    \x01\x12\x04\xbf\x05\x1a2\n\x0f\n\x07\x04\x07\x03\0\x02\x02\x03\x12\x04\
    \xbf\x0556\n\x0c\n\x04\x04\x07\x02\x06\x12\x04\xc2\x05\x02\x20\n\r\n\x05\
    \x04\x07\x02\x06\x06\x12\x04\xc2\x05\x02\x0e\n\r\n\x05\x04\x07\x02\x06\
    \x01\x12\x04\xc2\x05\x0f\x1b\n\r\n\x05\x04\x07\x02\x06\x03\x12\x04\xc2\
    \x05\x1e\x1f\n\x0b\n\x03\x04\x07\t\x12\x04\xc4\x05\x02\r\n\x0c\n\x04\x04\
    \x07\t\0\x12\x04\xc4\x05\x0b\x0c\n\r\n\x05\x04\x07\t\0\x01\x12\x04\xc4\
    \x05\x0b\x0c\n\r\n\x05\x04\x07\t\0\x02\x12\x04\xc4\x05\x0b\x0c\nK\n\x02\
    \x04\x08\x12\x06\xc8\x05\0\xe6\x05\x01\x1a=\x20Metadata\x20output\x20(i.\
    e.,\x20non-Tensor)\x20for\x20a\x20single\x20Run()\x20call.\n\n\x0b\n\x03\
    \x04\x08\x01\x12\x04\xc8\x05\x08\x13\n\xbb\x01\n\x04\x04\x08\x02\0\x12\
    \x04\xcc\x05\x02\x1b\x1a\xac\x01\x20Statistics\x20traced\x20for\x20this\
    \x20step.\x20Populated\x20if\x20tracing\x20is\x20turned\x20on\x20via\x20\
    the\n\x20\"RunOptions\"\x20proto.\n\x20EXPERIMENTAL:\x20The\x20format\
    \x20and\x20set\x20of\x20events\x20may\x20change\x20in\x20future\x20versi\
    ons.\n\n\r\n\x05\x04\x08\x02\0\x06\x12\x04\xcc\x05\x02\x0b\n\r\n\x05\x04\
    \x08\x02\0\x01\x12\x04\xcc\x05\x0c\x16\n\r\n\x05\x04\x08\x02\0\x03\x12\
    \x04\xcc\x05\x19\x1a\nK\n\x04\x04\x08\x02\x01\x12\x04\xcf\x05\x02\x1e\
    \x1a=\x20The\x20cost\x20graph\x20for\x20the\x20computation\x20defined\
    \x20by\x20the\x20run\x20call.\n\n\r\n\x05\x04\x08\x02\x01\x06\x12\x04\
    \xcf\x05\x02\x0e\n\r\n\x05\x04\x08\x02\x01\x01\x12\x04\xcf\x05\x0f\x19\n\
    \r\n\x05\x04\x08\x02\x01\x03\x12\x04\xcf\x05\x1c\x1d\n?\n\x04\x04\x08\
    \x02\x02\x12\x04\xd2\x05\x02)\x1a1\x20Graphs\x20of\x20the\x20partitions\
    \x20executed\x20by\x20executors.\n\n\r\n\x05\x04\x08\x02\x02\x04\x12\x04\
    \xd2\x05\x02\n\n\r\n\x05\x04\x08\x02\x02\x06\x12\x04\xd2\x05\x0b\x13\n\r\
    \n\x05\x04\x08\x02\x02\x01\x12\x04\xd2\x05\x14$\n\r\n\x05\x04\x08\x02\
    \x02\x03\x12\x04\xd2\x05'(\n\x0e\n\x04\x04\x08\x03\0\x12\x06\xd4\x05\x02\
    \xda\x05\x03\n\r\n\x05\x04\x08\x03\0\x01\x12\x04\xd4\x05\n\x18\nW\n\x06\
    \x04\x08\x03\0\x02\0\x12\x04\xd6\x05\x04+\x1aG\x20TODO(nareshmodi):\x20I\
    nclude\x20some\x20sort\x20of\x20function/cache-key\x20identifier?\n\n\
    \x0f\n\x07\x04\x08\x03\0\x02\0\x04\x12\x04\xd6\x05\x04\x0c\n\x0f\n\x07\
    \x04\x08\x03\0\x02\0\x06\x12\x04\xd6\x05\r\x15\n\x0f\n\x07\x04\x08\x03\0\
    \x02\0\x01\x12\x04\xd6\x05\x16&\n\x0f\n\x07\x04\x08\x03\0\x02\0\x03\x12\
    \x04\xd6\x05)*\n\x0e\n\x06\x04\x08\x03\0\x02\x01\x12\x04\xd8\x05\x04(\n\
    \x0f\n\x07\x04\x08\x03\0\x02\x01\x06\x12\x04\xd8\x05\x04\x0c\n\x0f\n\x07\
    \x04\x08\x03\0\x02\x01\x01\x12\x04\xd8\x05\r#\n\x0f\n\x07\x04\x08\x03\0\
    \x02\x01\x03\x12\x04\xd8\x05&'\n\x0e\n\x06\x04\x08\x03\0\x02\x02\x12\x04\
    \xd9\x05\x04)\n\x0f\n\x07\x04\x08\x03\0\x02\x02\x06\x12\x04\xd9\x05\x04\
    \x0c\n\x0f\n\x07\x04\x08\x03\0\x02\x02\x01\x12\x04\xd9\x05\r$\n\x0f\n\
    \x07\x04\x08\x03\0\x02\x02\x03\x12\x04\xd9\x05'(\n\xb8\x05\n\x04\x04\x08\
    \x02\x03\x12\x04\xe5\x05\x02.\x1a\xa9\x05\x20This\x20is\x20only\x20popul\
    ated\x20for\x20graphs\x20that\x20are\x20run\x20as\x20functions\x20in\x20\
    TensorFlow\n\x20V2.\x20There\x20will\x20be\x20an\x20entry\x20below\x20fo\
    r\x20each\x20function\x20that\x20is\x20traced.\n\x20The\x20main\x20use\
    \x20cases\x20of\x20the\x20post_optimization_graph\x20and\x20the\x20parti\
    tion_graphs\n\x20is\x20to\x20give\x20the\x20caller\x20insight\x20into\
    \x20the\x20graphs\x20that\x20were\x20actually\x20run\x20by\x20the\n\x20r\
    untime.\x20Additional\x20information\x20(such\x20as\x20those\x20in\x20st\
    ep_stats)\x20will\x20match\n\x20these\x20graphs.\n\x20We\x20also\x20incl\
    ude\x20the\x20pre_optimization_graph\x20since\x20it\x20is\x20usually\x20\
    easier\x20to\n\x20read,\x20and\x20is\x20helpful\x20in\x20situations\x20w\
    here\x20the\x20caller\x20wants\x20to\x20get\x20a\x20high\n\x20level\x20i\
    dea\x20of\x20what\x20the\x20built\x20graph\x20looks\x20like\x20(since\
    \x20the\x20various\x20graph\n\x20optimization\x20passes\x20might\x20chan\
    ge\x20the\x20structure\x20of\x20the\x20graph\x20significantly).\n\n\r\n\
    \x05\x04\x08\x02\x03\x04\x12\x04\xe5\x05\x02\n\n\r\n\x05\x04\x08\x02\x03\
    \x06\x12\x04\xe5\x05\x0b\x19\n\r\n\x05\x04\x08\x02\x03\x01\x12\x04\xe5\
    \x05\x1a)\n\r\n\x05\x04\x08\x02\x03\x03\x12\x04\xe5\x05,-\nI\n\x02\x04\t\
    \x12\x06\xe9\x05\0\xf1\x05\x01\x1a;\x20Defines\x20a\x20connection\x20bet\
    ween\x20two\x20tensors\x20in\x20a\x20`GraphDef`.\n\n\x0b\n\x03\x04\t\x01\
    \x12\x04\xe9\x05\x08\x18\nq\n\x04\x04\t\x02\0\x12\x04\xec\x05\x02\x19\
    \x1ac\x20A\x20tensor\x20name.\x20The\x20value\x20of\x20this\x20tensor\
    \x20will\x20be\x20substituted\x20for\n\x20the\x20tensor\x20named\x20in\
    \x20`to_tensor`.\n\n\r\n\x05\x04\t\x02\0\x05\x12\x04\xec\x05\x02\x08\n\r\
    \n\x05\x04\t\x02\0\x01\x12\x04\xec\x05\t\x14\n\r\n\x05\x04\t\x02\0\x03\
    \x12\x04\xec\x05\x17\x18\ny\n\x04\x04\t\x02\x01\x12\x04\xf0\x05\x02\x17\
    \x1ak\x20A\x20tensor\x20name.\x20The\x20value\x20of\x20this\x20tensor\
    \x20will\x20be\x20bound\x20to\x20the\n\x20value\x20of\x20the\x20tensor\
    \x20named\x20in\x20`from_tensor`.\n\n\r\n\x05\x04\t\x02\x01\x05\x12\x04\
    \xf0\x05\x02\x08\n\r\n\x05\x04\t\x02\x01\x01\x12\x04\xf0\x05\t\x12\n\r\n\
    \x05\x04\t\x02\x01\x03\x12\x04\xf0\x05\x15\x16\n\xa9\x01\n\x02\x04\n\x12\
    \x06\xf7\x05\0\xcb\x06\x01\x1a\x9a\x01\x20Defines\x20a\x20subgraph\x20in\
    \x20another\x20`GraphDef`\x20as\x20a\x20set\x20of\x20feed\x20points\x20a\
    nd\x20nodes\n\x20to\x20be\x20fetched\x20or\x20executed.\n\n\x20Compare\
    \x20with\x20the\x20arguments\x20to\x20`Session::Run()`.\n\n\x0b\n\x03\
    \x04\n\x01\x12\x04\xf7\x05\x08\x17\nU\n\x04\x04\n\x02\0\x12\x04\xf9\x05\
    \x02\x1b\x1aG\x20Tensors\x20to\x20be\x20fed\x20in\x20the\x20callable.\
    \x20Each\x20feed\x20is\x20the\x20name\x20of\x20a\x20tensor.\n\n\r\n\x05\
    \x04\n\x02\0\x04\x12\x04\xf9\x05\x02\n\n\r\n\x05\x04\n\x02\0\x05\x12\x04\
    \xf9\x05\x0b\x11\n\r\n\x05\x04\n\x02\0\x01\x12\x04\xf9\x05\x12\x16\n\r\n\
    \x05\x04\n\x02\0\x03\x12\x04\xf9\x05\x19\x1a\n\xe2\x01\n\x04\x04\n\x02\
    \x01\x12\x04\xfe\x05\x02\x1c\x1a\xd3\x01\x20Fetches.\x20A\x20list\x20of\
    ...
    \r\n\x05\x04\n\x02\x01\x04\x12\x04\xfe\x05\x02\n\n\r\n\x05\x04\n\x02\x01\
    \x05\x12\x04\xfe\x05\x0b\x11\n\r\n\x05\x04\n\x02\x01\x01\x12\x04\xfe\x05\
    \x12\x17\n\r\n\x05\x04\n\x02\x01\x03\x12\x04\xfe\x05\x1a\x1b\n\x88\x01\n\
    \x04\x04\n\x02\x02\x12\x04\x82\x06\x02\x1d\x1az\x20Target\x20Nodes.\x20A\
    \x20list\x20of\x20node\x20names.\x20The\x20named\x20nodes\x20will\x20be\
    \x20run\x20by\x20the\n\x20callable\x20but\x20their\x20outputs\x20will\
    \x20not\x20be\x20returned.\n\n\r\n\x05\x04\n\x02\x02\x04\x12\x04\x82\x06\
    \x02\n\n\r\n\x05\x04\n\x02\x02\x05\x12\x04\x82\x06\x0b\x11\n\r\n\x05\x04\
    \n\x02\x02\x01\x12\x04\x82\x06\x12\x18\n\r\n\x05\x04\n\x02\x02\x03\x12\
    \x04\x82\x06\x1b\x1c\n9\n\x04\x04\n\x02\x03\x12\x04\x85\x06\x02\x1d\x1a+\
    \x20Options\x20that\x20will\x20be\x20applied\x20to\x20each\x20run.\n\n\r\
    \n\x05\x04\n\x02\x03\x06\x12\x04\x85\x06\x02\x0c\n\r\n\x05\x04\n\x02\x03\
    \x01\x12\x04\x85\x06\r\x18\n\r\n\x05\x04\n\x02\x03\x03\x12\x04\x85\x06\
    \x1b\x1c\n\xb0\x01\n\x04\x04\n\x02\x04\x12\x04\x8a\x06\x022\x1a\xa1\x01\
    \x20Tensors\x20to\x20be\x20connected\x20in\x20the\x20callable.\x20Each\
    \x20TensorConnection\x20denotes\n\x20a\x20pair\x20of\x20tensors\x20in\
    \x20the\x20graph,\x20between\x20which\x20an\x20edge\x20will\x20be\x20cre\
    ated\n\x20in\x20the\x20callable.\n\n\r\n\x05\x04\n\x02\x04\x04\x12\x04\
    \x8a\x06\x02\n\n\r\n\x05\x04\n\x02\x04\x06\x12\x04\x8a\x06\x0b\x1b\n\r\n\
    \x05\x04\n\x02\x04\x01\x12\x04\x8a\x06\x1c-\n\r\n\x05\x04\n\x02\x04\x03\
    \x12\x04\x8a\x0601\n\xb7\r\n\x04\x04\n\x02\x05\x12\x04\xbb\x06\x02'\x1a\
    \xa8\r\x20The\x20Tensor\x20objects\x20fed\x20in\x20the\x20callable\x20an\
    d\x20fetched\x20from\x20the\x20callable\n\x20are\x20expected\x20to\x20be\
    \x20backed\x20by\x20host\x20(CPU)\x20memory\x20by\x20default.\n\n\x20The\
    \x20options\x20below\x20allow\x20changing\x20that\x20-\x20feeding\x20ten\
    sors\x20backed\x20by\n\x20device\x20memory,\x20or\x20returning\x20tensor\
    s\x20that\x20are\x20backed\x20by\x20device\x20memory.\n\n\x20The\x20maps\
    ...
    \x04\xbb\x06\x02\x15\n\r\n\x05\x04\n\x02\x05\x01\x12\x04\xbb\x06\x16\"\n\
    \r\n\x05\x04\n\x02\x05\x03\x12\x04\xbb\x06%&\n\x0c\n\x04\x04\n\x02\x06\
    \x12\x04\xbc\x06\x02(\n\r\n\x05\x04\n\x02\x06\x06\x12\x04\xbc\x06\x02\
    \x15\n\r\n\x05\x04\n\x02\x06\x01\x12\x04\xbc\x06\x16#\n\r\n\x05\x04\n\
    \x02\x06\x03\x12\x04\xbc\x06&'\n\xf5\x04\n\x04\x04\n\x02\x07\x12\x04\xc8\
    \x06\x02\x1b\x1a\xe6\x04\x20By\x20default,\x20RunCallable()\x20will\x20s\
    ynchronize\x20the\x20GPU\x20stream\x20before\x20returning\n\x20fetched\
    \x20tensors\x20on\x20a\x20GPU\x20device,\x20to\x20ensure\x20that\x20the\
    \x20values\x20in\x20those\x20tensors\n\x20have\x20been\x20produced.\x20T\
    his\x20simplifies\x20interacting\x20with\x20the\x20tensors,\x20but\n\x20\
    potentially\x20incurs\x20a\x20performance\x20hit.\n\n\x20If\x20this\x20o\
    ptions\x20is\x20set\x20to\x20true,\x20the\x20caller\x20is\x20responsible\
    \x20for\x20ensuring\n\x20that\x20the\x20values\x20in\x20the\x20fetched\
    \x20tensors\x20have\x20been\x20produced\x20before\x20they\x20are\n\x20us\
    ed.\x20The\x20caller\x20can\x20do\x20this\x20by\x20invoking\x20`Device::\
    Sync()`\x20on\x20the\x20underlying\n\x20device(s),\x20or\x20by\x20feedin\
    g\x20the\x20tensors\x20back\x20to\x20the\x20same\x20Session\x20using\n\
    \x20`feed_devices`\x20with\x20the\x20same\x20corresponding\x20device\x20\
    name.\n\n\r\n\x05\x04\n\x02\x07\x05\x12\x04\xc8\x06\x02\x06\n\r\n\x05\
    \x04\n\x02\x07\x01\x12\x04\xc8\x06\x07\x16\n\r\n\x05\x04\n\x02\x07\x03\
    \x12\x04\xc8\x06\x19\x1ab\x06proto3\
";
