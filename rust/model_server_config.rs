...
impl ModelConfig {
    ...
    pub fn get_model_version_policy(&self) -> &super::file_system_storage_path_source::FileSystemStoragePathSourceConfig_ServableVersionPolicy {
        self.model_version_policy.as_ref().unwrap_or_else(|| <super::file_system_storage_path_source::FileSystemStoragePathSourceConfig_ServableVersionPolicy as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn get_logging_config(&self) -> &super::logging_config::LoggingConfig {
        self.logging_config.as_ref().unwrap_or_else(|| <super::logging_config::LoggingConfig as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for ModelConfig {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.model_type != ModelType::MODEL_TYPE_UNSPECIFIED {
            os.write_enum(3, ::protobuf::ProtobufEnum::value(&self.model_type))?;
        }
        if !self.model_platform.is_empty() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "alias",
                |m: &ModelConfig| { &m.alias },
                |m: &mut ModelConfig| { &mut m.alias },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "base_path",
    ...
    fn default_instance() -> &'static ModelConfig {
        static instance: ::protobuf::rt::LazyV2<ModelConfig> = ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for ModelConfigList {
    ...
    fn default_instance() -> &'static ModelConfigList {
        static instance: ::protobuf::rt::LazyV2<ModelConfigList> = ::protobuf::rt::LazyV2::INIT;
...
impl ModelServerConfig {
    ...
    pub fn get_model_config_list(&self) -> &ModelConfigList {
        match self.config {
            ...
            _ => <ModelConfigList as ::protobuf::Message>::default_instance(),
        }
    }
...
impl ::protobuf::Message for ModelServerConfig {
    ...
    fn default_instance() -> &'static ModelServerConfig {
        static instance: ::protobuf::rt::LazyV2<ModelServerConfig> = ::protobuf::rt::LazyV2::INIT;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    stem_storage_path_source.proto\"\xa9\x04\n\x0bModelConfig\x12\x12\n\x04n\
    ame\x18\x01\x20\x01(\tR\x04name\x12\x14\n\x05alias\x18\t\x20\x03(\tR\x05\
    alias\x12\x1b\n\tbase_path\x18\x02\x20\x01(\tR\x08basePath\x12@\n\nmodel\
    _type\x18\x03\x20\x01(\x0e2\x1d.tensorflow.serving.ModelTypeR\tmodelType\
    B\x02\x18\x01\x12%\n\x0emodel_platform\x18\x04\x20\x01(\tR\rmodelPlatfor\
    m\x12}\n\x14model_version_policy\x18\x07\x20\x01(\x0b2K.tensorflow.servi\
    ng.FileSystemStoragePathSourceConfig.ServableVersionPolicyR\x12modelVers\
    ionPolicy\x12Y\n\x0eversion_labels\x18\x08\x20\x03(\x0b22.tensorflow.ser\
    ving.ModelConfig.VersionLabelsEntryR\rversionLabels\x12H\n\x0elogging_co\
    nfig\x18\x06\x20\x01(\x0b2!.tensorflow.serving.LoggingConfigR\rloggingCo\
    nfig\x1a@\n\x12VersionLabelsEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\
    \x03key\x12\x14\n\x05value\x18\x02\x20\x01(\x03R\x05value:\x028\x01J\x04\
    \x08\x05\x10\x06\"J\n\x0fModelConfigList\x127\n\x06config\x18\x01\x20\
    \x03(\x0b2\x1f.tensorflow.serving.ModelConfigR\x06config\"\xb8\x01\n\x11\
    ModelServerConfig\x12Q\n\x11model_config_list\x18\x01\x20\x01(\x0b2#.ten\
    sorflow.serving.ModelConfigListH\0R\x0fmodelConfigList\x12F\n\x13custom_\
    model_config\x18\x02\x20\x01(\x0b2\x14.google.protobuf.AnyH\0R\x11custom\
    ModelConfigB\x08\n\x06config*N\n\tModelType\x12\x1e\n\x16MODEL_TYPE_UNSP\
    ECIFIED\x10\0\x1a\x02\x08\x01\x12\x12\n\nTENSORFLOW\x10\x01\x1a\x02\x08\
    \x01\x12\r\n\x05OTHER\x10\x02\x1a\x02\x08\x01B\x03\xf8\x01\x01J\xee\x19\
    \n\x06\x12\x04\0\0W\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\
    \x12\x03\x02\0\x1b\n\x08\n\x01\x08\x12\x03\x03\0\x1f\n\t\n\x02\x08\x1f\
    \x12\x03\x03\0\x1f\n\t\n\x02\x03\0\x12\x03\x05\0#\n\t\n\x02\x03\x01\x12\
    \x03\x06\08\n\t\n\x02\x03\x02\x12\x03\x07\0W\n?\n\x02\x05\0\x12\x04\x0b\
    \0\x0f\x01\x1a3\x20The\x20type\x20of\x20model.\n\x20TODO(b/31336131):\
    \x20DEPRECATED.\n\n\n\n\x03\x05\0\x01\x12\x03\x0b\x05\x0e\n\x0b\n\x04\
    \x05\0\x02\0\x12\x03\x0c\x021\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03\x0c\
    \x02\x18\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x0c\x1b\x1c\n\x0c\n\x05\x05\
    \0\x02\0\x03\x12\x03\x0c\x1d0\n\r\n\x06\x05\0\x02\0\x03\x01\x12\x03\x0c\
    \x1e/\n\x0b\n\x04\x05\0\x02\x01\x12\x03\r\x02%\n\x0c\n\x05\x05\0\x02\x01\
    \x01\x12\x03\r\x02\x0c\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\r\x0f\x10\n\
    \x0c\n\x05\x05\0\x02\x01\x03\x12\x03\r\x11$\n\r\n\x06\x05\0\x02\x01\x03\
    \x01\x12\x03\r\x12#\n\x0b\n\x04\x05\0\x02\x02\x12\x03\x0e\x02\x20\n\x0c\
    \n\x05\x05\0\x02\x02\x01\x12\x03\x0e\x02\x07\n\x0c\n\x05\x05\0\x02\x02\
    \x02\x12\x03\x0e\n\x0b\n\x0c\n\x05\x05\0\x02\x02\x03\x12\x03\x0e\x0c\x1f\
    \n\r\n\x06\x05\0\x02\x02\x03\x01\x12\x03\x0e\r\x1e\nD\n\x02\x04\0\x12\
    \x04\x12\0G\x01\x1a8\x20Common\x20configuration\x20for\x20loading\x20a\
    \x20model\x20being\x20served.\n\n\n\n\x03\x04\0\x01\x12\x03\x12\x08\x13\
    \n!\n\x04\x04\0\x02\0\x12\x03\x14\x02\x12\x1a\x14\x20Name\x20of\x20the\
    \x20model.\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x14\x02\x08\n\x0c\n\x05\
    \x04\0\x02\0\x01\x12\x03\x14\t\r\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\x14\
    \x10\x11\n\x8b\x01\n\x04\x04\0\x02\x01\x12\x03\x18\x02\x1c\x1a~\x20List\
    \x20of\x20aliases\x20which\x20can\x20be\x20used\x20for\x20addressing\x20\
    this\x20model\x20instead\x20of\n\x20using\x20the\x20model\x20name.\x20Th\
    is\x20is\x20an\x20experimental\x20field.\n\n\x0c\n\x05\x04\0\x02\x01\x04\
    \x12\x03\x18\x02\n\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x18\x0b\x11\n\
    \x0c\n\x05\x04\0\x02\x01\x01\x12\x03\x18\x12\x17\n\x0c\n\x05\x04\0\x02\
    \x01\x03\x12\x03\x18\x1a\x1b\n\x8a\x03\n\x04\x04\0\x02\x02\x12\x03!\x02\
    \x17\x1a\xfc\x02\x20Base\x20path\x20to\x20the\x20model,\x20excluding\x20\
    the\x20version\x20directory.\n\x20E.g>\x20for\x20a\x20model\x20at\x20/fo\
    o/bar/my_model/123,\x20where\x20123\x20is\x20the\x20version,\x20the\n\
    \x20base\x20path\x20is\x20/foo/bar/my_model.\n\n\x20(This\x20can\x20be\
    \x20changed\x20once\x20a\x20model\x20is\x20in\x20serving,\x20*if*\x20the\
    \x20underlying\x20data\n\x20remains\x20the\x20same.\x20Otherwise\x20ther\
    e\x20are\x20no\x20guarantees\x20about\x20whether\x20the\x20old\n\x20or\
    \x20new\x20data\x20will\x20be\x20used\x20for\x20model\x20versions\x20cur\
    rently\x20loaded.)\n\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03!\x02\x08\n\
    \x0c\n\x05\x04\0\x02\x02\x01\x12\x03!\t\x12\n\x0c\n\x05\x04\0\x02\x02\
    \x03\x12\x03!\x15\x16\na\n\x04\x04\0\x02\x03\x12\x03%\x02/\x1aT\x20Type\
    \x20of\x20model.\n\x20TODO(b/31336131):\x20DEPRECATED.\x20Please\x20use\
    \x20'model_platform'\x20instead.\n\n\x0c\n\x05\x04\0\x02\x03\x06\x12\x03\
    %\x02\x0b\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03%\x0c\x16\n\x0c\n\x05\x04\
    \0\x02\x03\x03\x12\x03%\x19\x1a\n\x0c\n\x05\x04\0\x02\x03\x08\x12\x03%\
    \x1b.\n\r\n\x06\x04\0\x02\x03\x08\x03\x12\x03%\x1c-\nh\n\x04\x04\0\x02\
    \x04\x12\x03*\x02\x1c\x1a[\x20Type\x20of\x20model\x20(e.g.\x20\"tensorfl\
    ow\").\n\n\x20(This\x20cannot\x20be\x20changed\x20once\x20a\x20model\x20\
    ...
    \x043\x024\x08\x1a\xf9\x01\x20Version\x20policy\x20for\x20the\x20model\
    \x20indicating\x20which\x20version(s)\x20of\x20the\x20model\x20to\n\x20l\
    oad\x20and\x20make\x20available\x20for\x20serving\x20simultaneously.\n\
    \x20The\x20default\x20option\x20is\x20to\x20serve\x20only\x20the\x20late\
    st\x20version\x20of\x20the\x20model.\n\n\x20(This\x20can\x20be\x20change\
    d\x20once\x20a\x20model\x20is\x20in\x20serving.)\n\n\x0c\n\x05\x04\0\x02\
    \x05\x06\x12\x033\x029\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x033:N\n\x0c\n\
    \x05\x04\0\x02\x05\x03\x12\x034\x06\x07\n\xd1\x05\n\x04\x04\0\x02\x06\
    \x12\x03A\x02(\x1a\xc3\x05\x20String\x20labels\x20to\x20associate\x20wit\
    h\x20versions\x20of\x20the\x20model,\x20allowing\x20inference\n\x20queri\
    es\x20to\x20refer\x20to\x20versions\x20by\x20label\x20instead\x20of\x20n\
    umber.\x20Multiple\x20labels\n\x20can\x20map\x20to\x20the\x20same\x20ver\
    sion,\x20but\x20not\x20vice-versa.\n\n\x20An\x20envisioned\x20use-case\
    \x20for\x20these\x20labels\x20is\x20canarying\x20tentative\x20versions.\
    \n\x20For\x20example,\x20one\x20can\x20assign\x20labels\x20\"stable\"\
    \x20and\x20\"canary\"\x20to\x20two\x20specific\n\x20versions.\x20Perhaps\
    \x20initially\x20\"stable\"\x20is\x20assigned\x20to\x20version\x200\x20a\
    nd\x20\"canary\"\n\x20to\x20version\x201.\x20Once\x20version\x201\x20pas\
    ses\x20canary,\x20one\x20can\x20shift\x20the\x20\"stable\"\n\x20label\
    \x20to\x20refer\x20to\x20version\x201\x20(at\x20that\x20point\x20both\
    \x20labels\x20map\x20to\x20the\x20same\n\x20version\x20--\x20version\x20\
    1\x20--\x20which\x20is\x20fine).\x20Later\x20once\x20version\x202\x20is\
    \x20ready\x20to\n\x20canary\x20one\x20can\x20move\x20the\x20\"canary\"\
    \x20label\x20to\x20version\x202.\x20And\x20so\x20on.\n\n\x0c\n\x05\x04\0\
    \x02\x06\x06\x12\x03A\x02\x14\n\x0c\n\x05\x04\0\x02\x06\x01\x12\x03A\x15\
    #\n\x0c\n\x05\x04\0\x02\x06\x03\x12\x03A&'\n{\n\x04\x04\0\x02\x07\x12\
    \x03F\x02#\x1an\x20Configures\x20logging\x20requests\x20and\x20responses\
    ,\x20to\x20the\x20model.\n\n\x20(This\x20can\x20be\x20changed\x20once\
    \x20a\x20model\x20is\x20in\x20serving.)\n\n\x0c\n\x05\x04\0\x02\x07\x06\
    \x12\x03F\x02\x0f\n\x0c\n\x05\x04\0\x02\x07\x01\x12\x03F\x10\x1e\n\x0c\n\
    \x05\x04\0\x02\x07\x03\x12\x03F!\"\n=\n\x02\x04\x01\x12\x04J\0L\x01\x1a1\
    \x20Static\x20list\x20of\x20models\x20to\x20be\x20loaded\x20for\x20servi\
    ng.\n\n\n\n\x03\x04\x01\x01\x12\x03J\x08\x17\n\x0b\n\x04\x04\x01\x02\0\
    \x12\x03K\x02\"\n\x0c\n\x05\x04\x01\x02\0\x04\x12\x03K\x02\n\n\x0c\n\x05\
    \x04\x01\x02\0\x06\x12\x03K\x0b\x16\n\x0c\n\x05\x04\x01\x02\0\x01\x12\
    \x03K\x17\x1d\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03K\x20!\n!\n\x02\x04\
    \x02\x12\x04O\0W\x01\x1a\x15\x20ModelServer\x20config.\n\n\n\n\x03\x04\
    \x02\x01\x12\x03O\x08\x19\n\xd6\x01\n\x04\x04\x02\x08\0\x12\x04S\x02V\
    \x03\x1a\xc7\x01\x20ModelServer\x20takes\x20either\x20a\x20static\x20fil\
    e-based\x20model\x20config\x20list\x20or\x20an\x20Any\n\x20proto\x20repr\
    esenting\x20custom\x20model\x20config\x20that\x20is\x20fetched\x20dynami\
    cally\x20at\n\x20runtime\x20(through\x20network\x20RPC,\x20custom\x20ser\
    vice,\x20etc.).\n\n\x0c\n\x05\x04\x02\x08\0\x01\x12\x03S\x08\x0e\n\x0b\n\
    \x04\x04\x02\x02\0\x12\x03T\x04*\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03T\
    \x04\x13\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03T\x14%\n\x0c\n\x05\x04\x02\
    \x02\0\x03\x12\x03T()\n\x0b\n\x04\x04\x02\x02\x01\x12\x03U\x040\n\x0c\n\
    \x05\x04\x02\x02\x01\x06\x12\x03U\x04\x17\n\x0c\n\x05\x04\x02\x02\x01\
